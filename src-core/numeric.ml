...
type fix_float_0 = int
;;

type fix_float_1 = int
;;

type fix_float_2 = int
;;

type fix_float_3 = int
;;

type fix_float_4 = int
;;

let float_Convert_0_0 (f : fix_float_0) (x : fix_float_0)  : fix_float_0 =
    f
;;

let float_Convert_0_1 (f : fix_float_0) (x : fix_float_1)  : fix_float_1 =
    ( * ) f 10
;;

let float_Convert_0_2 (f : fix_float_0) (x : fix_float_2)  : fix_float_2 =
    ( * ) f 100
;;

let float_Convert_0_3 (f : fix_float_0) (x : fix_float_3)  : fix_float_3 =
    ( * ) f 1000
;;

let float_Convert_0_4 (f : fix_float_0) (x : fix_float_4)  : fix_float_4 =
    ( * ) f 10000
;;

let float_Convert_1_0 (f : fix_float_1) (x : fix_float_0)  : fix_float_0 =
    (/) f 10
;;

let float_Convert_1_1 (f : fix_float_1) (x : fix_float_1)  : fix_float_1 =
    f
;;

let float_Convert_1_2 (f : fix_float_1) (x : fix_float_2)  : fix_float_2 =
    ( * ) f 10
;;

let float_Convert_1_3 (f : fix_float_1) (x : fix_float_3)  : fix_float_3 =
    ( * ) f 100
;;

let float_Convert_1_4 (f : fix_float_1) (x : fix_float_4)  : fix_float_4 =
    ( * ) f 1000
;;

let float_Convert_2_0 (f : fix_float_2) (x : fix_float_0)  : fix_float_0 =
    (/) f 100
;;

let float_Convert_2_1 (f : fix_float_2) (x : fix_float_1)  : fix_float_1 =
    (/) f 10
;;

let float_Convert_2_2 (f : fix_float_2) (x : fix_float_2)  : fix_float_2 =
    f
;;

let float_Convert_2_3 (f : fix_float_2) (x : fix_float_3)  : fix_float_3 =
    ( * ) f 10
;;

let float_Convert_2_4 (f : fix_float_2) (x : fix_float_4)  : fix_float_4 =
    ( * ) f 100
;;

let float_Convert_3_0 (f : fix_float_3) (x : fix_float_0)  : fix_float_0 =
    (/) f 1000
;;

let float_Convert_3_1 (f : fix_float_3) (x : fix_float_1)  : fix_float_1 =
    (/) f 100
;;

let float_Convert_3_2 (f : fix_float_3) (x : fix_float_2)  : fix_float_2 =
    (/) f 10
;;

let float_Convert_3_3 (f : fix_float_3) (x : fix_float_3)  : fix_float_3 =
    f
;;

let float_Convert_3_4 (f : fix_float_3) (x : fix_float_4)  : fix_float_4 =
    ( * ) f 10
;;

let float_Convert_4_0 (f : fix_float_4) (x : fix_float_0)  : fix_float_0 =
    (/) f 10000
;;

let float_Convert_4_1 (f : fix_float_4) (x : fix_float_1)  : fix_float_1 =
    (/) f 1000
;;

let float_Convert_4_2 (f : fix_float_4) (x : fix_float_2)  : fix_float_2 =
    (/) f 100
;;

let float_Convert_4_3 (f : fix_float_4) (x : fix_float_3)  : fix_float_3 =
    (/) f 10
;;

let float_Convert_4_4 (f : fix_float_4) (x : fix_float_4)  : fix_float_4 =
    f
;;
