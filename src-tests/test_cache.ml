...
let new_cache =
  Fix_engine_transitions.add_to_cache
    (Test_cache_utils.new_cache_fix_msg, Test_cache_utils.cache)
...
Test_cache_utils.check_cache
  (Test_cache_utils.cache1, Test_cache_utils.test_cache_index)
...
;;
Test_cache_utils.check_cache
  (Test_cache_utils.cache2, Test_cache_utils.test_cache_index)
...
;;
Test_cache_utils.check_cache
  (Test_cache_utils.cache3, Test_cache_utils.test_cache_index)
