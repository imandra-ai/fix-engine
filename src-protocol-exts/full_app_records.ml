...
type full_fix_app_record_data =
    | Full_Record_EvntGrp of fix_evntgrp
    | Full_Record_SecAltIDGrp of fix_secaltidgrp
    | Full_Record_LegSecAltIDGrp of fix_legsecaltidgrp
    | Full_Record_InstrumentLeg of fix_instrumentleg
    | Full_Record_UndSecAltIDGrp of fix_undsecaltidgrp
    | Full_Record_UnderlyingStipulations of fix_underlyingstipulations
    | Full_Record_UnderlyingInstrument of fix_underlyinginstrument
    | Full_Record_Instrument of fix_instrument
    | Full_Record_InstrmtLegGrp of fix_instrmtleggrp
    | Full_Record_UndInstrmtGrp of fix_undinstrmtgrp
    | Full_Record_NstdPtys2SubGrp of fix_nstdptys2subgrp
    | Full_Record_NestedParties2 of fix_nestedparties2
    | Full_Record_AttrbGrp of fix_attrbgrp
    | Full_Record_PtysSubGrp of fix_ptyssubgrp
    | Full_Record_NstdPtysSubGrp of fix_nstdptyssubgrp
    | Full_Record_SettlPtysSubGrp of fix_settlptyssubgrp
    | Full_Record_SettlParties of fix_settlparties
    | Full_Record_DlvyInstGrp of fix_dlvyinstgrp
    | Full_Record_ClrInstGrp of fix_clrinstgrp
    | Full_Record_CommissionData of fix_commissiondata
    | Full_Record_MiscFeesGrp of fix_miscfeesgrp
    | Full_Record_NestedParties of fix_nestedparties
    | Full_Record_SettlInstructionsData of fix_settlinstructionsdata
    | Full_Record_OrdAllocGrp of fix_ordallocgrp
    | Full_Record_ExecAllocGrp of fix_execallocgrp
    | Full_Record_InstrumentExtension of fix_instrumentextension
    | Full_Record_FinancingDetails of fix_financingdetails
    | Full_Record_SpreadOrBenchmarkCurveData of fix_spreadorbenchmarkcurvedata
    | Full_Record_Parties of fix_parties
    | Full_Record_Stipulations of fix_stipulations
    | Full_Record_YieldData of fix_yielddata
    | Full_Record_AllocGrp of fix_allocgrp
    | Full_Record_AllocAckGrp of fix_allocackgrp
    | Full_Record_PositionQty of fix_positionqty
    | Full_Record_PositionAmountData of fix_positionamountdata
    | Full_Record_BidDescReqGrp of fix_biddescreqgrp
    | Full_Record_BidCompReqGrp of fix_bidcompreqgrp
    | Full_Record_BidCompRspGrp of fix_bidcomprspgrp
    | Full_Record_ExecCollGrp of fix_execcollgrp
    | Full_Record_TrdCollGrp of fix_trdcollgrp
    | Full_Record_UndInstrmtCollGrp of fix_undinstrmtcollgrp
    | Full_Record_TrdRegTimestamps of fix_trdregtimestamps
    | Full_Record_CollInqQualGrp of fix_collinqqualgrp
    | Full_Record_CpctyConfGrp of fix_cpctyconfgrp
    | Full_Record_OrderQtyData of fix_orderqtydata
    | Full_Record_PreAllocGrp of fix_preallocgrp
    | Full_Record_SideCrossOrdModGrp of fix_sidecrossordmodgrp
    | Full_Record_TrdgSesGrp of fix_trdgsesgrp
    | Full_Record_PegInstructions of fix_peginstructions
    | Full_Record_DiscretionInstructions of fix_discretioninstructions
    | Full_Record_SideCrossOrdCxlGrp of fix_sidecrossordcxlgrp
    | Full_Record_RelSymDerivSecGrp of fix_relsymderivsecgrp
    | Full_Record_RoutingGrp of fix_routinggrp
    | Full_Record_InstrmtGrp of fix_instrmtgrp
    | Full_Record_LinesOfTextGrp of fix_linesoftextgrp
    | Full_Record_LegStipulations of fix_legstipulations
    | Full_Record_ContraGrp of fix_contragrp
    | Full_Record_ContAmtGrp of fix_contamtgrp
    | Full_Record_InstrmtLegExecGrp of fix_instrmtlegexecgrp
    | Full_Record_InstrmtLegIOIGrp of fix_instrmtlegioigrp
    | Full_Record_IOIQualGrp of fix_ioiqualgrp
    | Full_Record_OrdListStatGrp of fix_ordliststatgrp
    | Full_Record_InstrmtStrkPxGrp of fix_instrmtstrkpxgrp
    | Full_Record_UndInstrmtStrkPxGrp of fix_undinstrmtstrkpxgrp
    | Full_Record_MDIncGrp of fix_mdincgrp
    | Full_Record_MDReqGrp of fix_mdreqgrp
    | Full_Record_InstrmtMDReqGrp of fix_instrmtmdreqgrp
    | Full_Record_MDRjctGrp of fix_mdrjctgrp
    | Full_Record_MDFullGrp of fix_mdfullgrp
    | Full_Record_QuotEntryGrp of fix_quotentrygrp
    | Full_Record_QuotSetGrp of fix_quotsetgrp
    | Full_Record_QuotEntryAckGrp of fix_quotentryackgrp
    | Full_Record_QuotSetAckGrp of fix_quotsetackgrp
    | Full_Record_NstdPtys3SubGrp of fix_nstdptys3subgrp
    | Full_Record_NestedParties3 of fix_nestedparties3
    | Full_Record_LegPreAllocGrp of fix_legpreallocgrp
    | Full_Record_PreAllocMlegGrp of fix_preallocmleggrp
    | Full_Record_LegOrdGrp of fix_legordgrp
    | Full_Record_ListOrdGrp of fix_listordgrp
    | Full_Record_AffectedOrdGrp of fix_affectedordgrp
    | Full_Record_PosUndInstrmtGrp of fix_posundinstrmtgrp
    | Full_Record_LegBenchmarkCurveData of fix_legbenchmarkcurvedata
    | Full_Record_QuotQualGrp of fix_quotqualgrp
    | Full_Record_LegQuotGrp of fix_legquotgrp
    | Full_Record_QuotCxlEntriesGrp of fix_quotcxlentriesgrp
    | Full_Record_QuotReqLegsGrp of fix_quotreqlegsgrp
    | Full_Record_QuotReqGrp of fix_quotreqgrp
    | Full_Record_QuotReqRjctGrp of fix_quotreqrjctgrp
    | Full_Record_LegQuotStatGrp of fix_legquotstatgrp
    | Full_Record_RFQReqGrp of fix_rfqreqgrp
    | Full_Record_RgstDtlsGrp of fix_rgstdtlsgrp
    | Full_Record_RgstDistInstGrp of fix_rgstdistinstgrp
    | Full_Record_InstrmtLegSecListGrp of fix_instrmtlegseclistgrp
    | Full_Record_SecListGrp of fix_seclistgrp
    | Full_Record_SecTypesGrp of fix_sectypesgrp
    | Full_Record_SettlInstGrp of fix_settlinstgrp
    | Full_Record_TrdAllocGrp of fix_trdallocgrp
    | Full_Record_TrdInstrmtLegGrp of fix_trdinstrmtleggrp
    | Full_Record_TrdCapRptSideGrp of fix_trdcaprptsidegrp
    | Full_Record_TrdCapDtGrp of fix_trdcapdtgrp
;;
