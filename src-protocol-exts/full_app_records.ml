...
type fix_rg_inner_ordliststatgrp = {
    ...
    f_OrdListStatGrp_ClOrdID : fix_string option;
    f_OrdListStatGrp_SecondaryClOrdID : fix_string option;
    f_OrdListStatGrp_CumQty : fix_float option;
    f_OrdListStatGrp_OrdStatus : fix_ordstatus option;
    f_OrdListStatGrp_WorkingIndicator : fix_workingindicator option;
    f_OrdListStatGrp_LeavesQty : fix_float option;
    f_OrdListStatGrp_CxlQty : fix_float option;
    f_OrdListStatGrp_AvgPx : fix_float option;
...
type fix_rg_inner_cpctyconfgrp = {
    ...
    f_CpctyConfGrp_OrderCapacityQty : fix_float option
}
;;
...
type fix_rg_inner_linesoftextgrp = {
    ...
    f_LinesOfTextGrp_Text : fix_string option;
...
type fix_rg_inner_undinstrmtstrkpxgrp = {
    ...
    f_UndInstrmtStrkPxGrp_Price : fix_float option;
...
type fix_rg_inner_posundinstrmtgrp = {
    ...
    f_PosUndInstrmtGrp_UnderlyingSettlPrice : fix_float option;
...
type fix_rg_inner_sidecrossordcxlgrp = {
    ...
    f_SideCrossOrdCxlGrp_OrigClOrdID : fix_string option;
    f_SideCrossOrdCxlGrp_ClOrdID : fix_string option;
...
type fix_rg_inner_trdcaprptsidegrp = {
    ...
    f_TrdCapRptSideGrp_OrderID : fix_string option;
...
type fix_rg_inner_quotentrygrp = {
    ...
    f_QuotEntryGrp_QuoteEntryID : fix_string option;
...
type fix_rg_inner_sidecrossordmodgrp = {
    ...
    f_SideCrossOrdModGrp_ClOrdID : fix_string option;
...
type fix_rg_inner_listordgrp = {
    ...
    f_ListOrdGrp_ClOrdID : fix_string option;
...
type fix_rg_inner_quotsetgrp = {
    ...
    f_QuotSetGrp_QuoteSetID : fix_string option;
