...
let parse_msg_heartbeat_field_tag = function
    | "112" -> Some Full_Msg_Heartbeat_TestReqID_Tag 
    |    _  -> None
;;

let parse_msg_logon_field_tag = function
...
let parse_msg_sequence_reset_field_tag = function
    | "123" -> Some Full_Msg_Sequence_Reset_GapFillFlag_Tag  
    | "36"  -> Some Full_Msg_Sequence_Reset_NewSeqNo_Tag     
    |    _  -> None
;;

let parse_msg_test_request_field_tag = function
    | "112" -> Some Full_Msg_Test_Request_TestReqID_Tag      
    |    _  -> None
;;

let parse_msg_business_reject_field_tag = function
