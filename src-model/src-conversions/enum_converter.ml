...
let convert__full_to_model_OrderAttributeTypes (f : fix_orderattributetypes)  =
    (match f with
...
let convert__model_to_full_OrderAttributeTypes (f : model_fix_orderattributetypes)  =
    (match f with
