...
let all_model_strings ( msg : full_app_msg_data ) =
    ...
    (match msg with
        ...
        | FIX_TL_Req_Field_Missing _ -> ((Model_string 17,"The field \"NewOrderSingle.Instrument.Symbol\" is required but missing.") :: ((Model_string 16,"The field \"NewOrderSingle.OrdType\" is required but missing.") :: ((Model_string 15,"The field \"NewOrderSingle.TransactTime\" is required but missing.") :: ((Model_string 14,"The field \"NewOrderSingle.Price\" is required but missing.") :: ((Model_string 13,"The field \"NewOrderSingle.Side\" is required but missing.") :: ((Model_string 12,"The field \"NewOrderSingle.ClOrdID\" is required but missing.") :: ((Model_string 11,"The field \"ExecutionReport.Instrument.Symbol\" is required but missing.") :: ((Model_string 10,"The field \"ExecutionReport.OrdStatus\" is required but missing.") :: ((Model_string 9,"The field \"ExecutionReport.CumQty\" is required but missing.") :: ((Model_string 8,"The field \"ExecutionReport.LeavesQty\" is required but missing.") :: ((Model_string 7,"The field \"ExecutionReport.Side\" is required but missing.") :: ((Model_string 6,"The field \"ExecutionReport.AvgPx\" is required but missing.") :: ((Model_string 5,"The field \"ExecutionReport.ExecType\" is required but missing.") :: ((Model_string 4,"The field \"ExecutionReport.ExecID\" is required but missing.") :: ((Model_string 3,"The field \"ExecutionReport.OrderID\" is required but missing.") :: [])))))))))))))))
    )
;;
