...
type fix_header = {
    ...
    h_on_behalf_of_comp_id            : fix_string option;   (* Tag 115  *)
    h_deliver_to_comp_id              : fix_string option;   (* Tag 128  *)
    h_secure_data_len                 : int option;   (* Tag 90   *)
    h_secure_data                     : int option;   (* Tag 91   *)
    h_sender_sub_id                   : fix_string option;   (* Tag 50   *)
    h_sender_location_id              : fix_string option;   (* Tag 142  *)
    h_target_sub_id                   : fix_string option;   (* Tag 57   *)
    h_target_location_id              : fix_string option;   (* Tag 143  *)
    h_on_behalf_of_sub_id             : fix_string option;   (* Tag 116  *)
    h_on_behalf_of_location_id        : fix_string option;   (* Tag 114  *)
    h_deliver_to_sub_id               : fix_string option;   (* Tag 129  *)
    h_deliver_to_location_id          : fix_string option;   (* Tag 145  *)
