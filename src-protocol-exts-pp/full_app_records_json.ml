...
let commissiondata_to_json (x)  : json =
    assoc_filter_nulls (("Commission",float_4_opt_to_json x.f_CommissionData_Commission) :: (("CommType",commtype_opt_to_json x.f_CommissionData_CommType) :: (("CommCurrency",currency_opt_to_json x.f_CommissionData_CommCurrency) :: (("FundRenewWaiv",fundrenewwaiv_opt_to_json x.f_CommissionData_FundRenewWaiv) :: []))))
;;
...
let ordercancelreplacerequestallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_OrderCancelReplaceRequestAllocs_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_OrderCancelReplaceRequestAllocs_AllocAccount) :: (("AllocShares",float_4_opt_to_json x.f_OrderCancelReplaceRequestAllocs_AllocShares) :: [])))
;;
...
let allocationmiscfees_to_json (x)  : json =
    assoc_filter_nulls (("NoMiscFees",int_opt_to_json x.f_AllocationMiscFees_NoMiscFees) :: (("MiscFeeAmt",float_4_opt_to_json x.f_AllocationMiscFees_MiscFeeAmt) :: (("MiscFeeCurr",currency_opt_to_json x.f_AllocationMiscFees_MiscFeeCurr) :: (("MiscFeeType",miscfeetype_opt_to_json x.f_AllocationMiscFees_MiscFeeType) :: []))))
;;
...
let executionreportcontrabrokers_to_json (x)  : json =
    assoc_filter_nulls (("NoContraBrokers",int_opt_to_json x.f_ExecutionReportContraBrokers_NoContraBrokers) :: (("ContraBroker",string_opt_to_json x.f_ExecutionReportContraBrokers_ContraBroker) :: (("ContraTrader",string_opt_to_json x.f_ExecutionReportContraBrokers_ContraTrader) :: (("ContraTradeQty",float_4_opt_to_json x.f_ExecutionReportContraBrokers_ContraTradeQty) :: (("ContraTradeTime",utctimestamp_opt_to_json x.f_ExecutionReportContraBrokers_ContraTradeTime) :: [])))))
;;
...
let ordersingleallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_OrderSingleAllocs_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_OrderSingleAllocs_AllocAccount) :: (("AllocShares",float_4_opt_to_json x.f_OrderSingleAllocs_AllocShares) :: [])))
;;
...
let yielddata_to_json (x)  : json =
    assoc_filter_nulls (("YieldType",yieldtype_opt_to_json x.f_YieldData_YieldType) :: (("Yield",float_4_opt_to_json x.f_YieldData_Yield) :: (("YieldCalcDate",localmktdate_opt_to_json x.f_YieldData_YieldCalcDate) :: (("YieldRedemptionDate",localmktdate_opt_to_json x.f_YieldData_YieldRedemptionDate) :: (("YieldRedemptionPrice",float_4_opt_to_json x.f_YieldData_YieldRedemptionPrice) :: (("YieldRedemptionPriceType",int_opt_to_json x.f_YieldData_YieldRedemptionPriceType) :: []))))))
;;
...
let allocationexecs_to_json (x)  : json =
    assoc_filter_nulls (("NoExecs",int_opt_to_json x.f_AllocationExecs_NoExecs) :: (("LastShares",float_4_opt_to_json x.f_AllocationExecs_LastShares) :: (("ExecID",string_opt_to_json x.f_AllocationExecs_ExecID) :: (("LastPx",float_4_opt_to_json x.f_AllocationExecs_LastPx) :: (("LastCapacity",lastcapacity_opt_to_json x.f_AllocationExecs_LastCapacity) :: [])))))
;;
...
let bidresponsebidcomponents_to_json (x)  : json =
    assoc_filter_nulls (("NoBidComponents",int_opt_to_json x.f_BidResponseBidComponents_NoBidComponents) :: (("Commission",float_4_opt_to_json x.f_BidResponseBidComponents_Commission) :: (("CommType",commtype_opt_to_json x.f_BidResponseBidComponents_CommType) :: (("ListID",string_opt_to_json x.f_BidResponseBidComponents_ListID) :: (("Country",string_opt_to_json x.f_BidResponseBidComponents_Country) :: (("Side",side_opt_to_json x.f_BidResponseBidComponents_Side) :: (("Price",float_4_opt_to_json x.f_BidResponseBidComponents_Price) :: (("PriceType",pricetype_opt_to_json x.f_BidResponseBidComponents_PriceType) :: (("FairValue",float_4_opt_to_json x.f_BidResponseBidComponents_FairValue) :: (("NetGrossInd",netgrossind_opt_to_json x.f_BidResponseBidComponents_NetGrossInd) :: (("SettlmntTyp",settlmnttyp_opt_to_json x.f_BidResponseBidComponents_SettlmntTyp) :: (("FutSettDate",localmktdate_opt_to_json x.f_BidResponseBidComponents_FutSettDate) :: (("TradingSessionID",string_opt_to_json x.f_BidResponseBidComponents_TradingSessionID) :: (("Text",string_opt_to_json x.f_BidResponseBidComponents_Text) :: (("EncodedTextLen",int_opt_to_json x.f_BidResponseBidComponents_EncodedTextLen) :: (("EncodedText",string_opt_to_json x.f_BidResponseBidComponents_EncodedText) :: []))))))))))))))))
;;
...
let biddescreqgrp_to_json (x)  : json =
    assoc_filter_nulls (("NoBidDescriptors",int_opt_to_json x.f_BidDescReqGrp_NoBidDescriptors) :: (("BidDescriptorType",biddescriptortype_opt_to_json x.f_BidDescReqGrp_BidDescriptorType) :: (("BidDescriptor",string_opt_to_json x.f_BidDescReqGrp_BidDescriptor) :: (("SideValueInd",sidevalueind_opt_to_json x.f_BidDescReqGrp_SideValueInd) :: (("LiquidityValue",float_4_opt_to_json x.f_BidDescReqGrp_LiquidityValue) :: (("LiquidityNumSecurities",int_opt_to_json x.f_BidDescReqGrp_LiquidityNumSecurities) :: (("LiquidityPctLow",float_4_opt_to_json x.f_BidDescReqGrp_LiquidityPctLow) :: (("LiquidityPctHigh",float_4_opt_to_json x.f_BidDescReqGrp_LiquidityPctHigh) :: (("EFPTrackingError",float_4_opt_to_json x.f_BidDescReqGrp_EFPTrackingError) :: (("FairValue",float_4_opt_to_json x.f_BidDescReqGrp_FairValue) :: (("OutsideIndexPct",float_4_opt_to_json x.f_BidDescReqGrp_OutsideIndexPct) :: (("ValueOfFutures",float_4_opt_to_json x.f_BidDescReqGrp_ValueOfFutures) :: []))))))))))))
;;
...
let allocationallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_AllocationAllocs_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_AllocationAllocs_AllocAccount) :: (("AllocPrice",float_4_opt_to_json x.f_AllocationAllocs_AllocPrice) :: (("AllocShares",float_4_opt_to_json x.f_AllocationAllocs_AllocShares) :: (("ProcessCode",processcode_opt_to_json x.f_AllocationAllocs_ProcessCode) :: (("BrokerOfCredit",string_opt_to_json x.f_AllocationAllocs_BrokerOfCredit) :: (("NotifyBrokerOfCredit",notifybrokerofcredit_opt_to_json x.f_AllocationAllocs_NotifyBrokerOfCredit) :: (("AllocHandlInst",allochandlinst_opt_to_json x.f_AllocationAllocs_AllocHandlInst) :: (("AllocText",string_opt_to_json x.f_AllocationAllocs_AllocText) :: (("EncodedAllocTextLen",int_opt_to_json x.f_AllocationAllocs_EncodedAllocTextLen) :: (("EncodedAllocText",string_opt_to_json x.f_AllocationAllocs_EncodedAllocText) :: (("ExecBroker",string_opt_to_json x.f_AllocationAllocs_ExecBroker) :: (("ClientID",string_opt_to_json x.f_AllocationAllocs_ClientID) :: (("Commission",float_4_opt_to_json x.f_AllocationAllocs_Commission) :: (("CommType",commtype_opt_to_json x.f_AllocationAllocs_CommType) :: (("AllocAvgPx",float_4_opt_to_json x.f_AllocationAllocs_AllocAvgPx) :: (("AllocNetMoney",float_4_opt_to_json x.f_AllocationAllocs_AllocNetMoney) :: (("SettlCurrAmt",float_4_opt_to_json x.f_AllocationAllocs_SettlCurrAmt) :: (("SettlCurrency",currency_opt_to_json x.f_AllocationAllocs_SettlCurrency) :: (("SettlCurrFxRate",float_opt_to_json x.f_AllocationAllocs_SettlCurrFxRate) :: (("SettlCurrFxRateCalc",char_opt_to_json x.f_AllocationAllocs_SettlCurrFxRateCalc) :: (("AccruedInterestAmt",float_4_opt_to_json x.f_AllocationAllocs_AccruedInterestAmt) :: (("SettlInstMode",settlinstmode_opt_to_json x.f_AllocationAllocs_SettlInstMode) :: [])))))))))))))))))))))))
;;
...
let positionamountdata_to_json (x)  : json =
    assoc_filter_nulls (("NoPosAmt",int_opt_to_json x.f_PositionAmountData_NoPosAmt) :: (("PosAmtType",posamttype_opt_to_json x.f_PositionAmountData_PosAmtType) :: (("PosAmt",float_4_opt_to_json x.f_PositionAmountData_PosAmt) :: [])))
;;
...
let miscfeesgrp_to_json (x)  : json =
    assoc_filter_nulls (("NoMiscFees",int_opt_to_json x.f_MiscFeesGrp_NoMiscFees) :: (("MiscFeeAmt",float_4_opt_to_json x.f_MiscFeesGrp_MiscFeeAmt) :: (("MiscFeeCurr",currency_opt_to_json x.f_MiscFeesGrp_MiscFeeCurr) :: (("MiscFeeType",miscfeetype_opt_to_json x.f_MiscFeesGrp_MiscFeeType) :: (("MiscFeeBasis",miscfeebasis_opt_to_json x.f_MiscFeesGrp_MiscFeeBasis) :: [])))))
;;
...
let ordliststatgrp_to_json (x)  : json =
    assoc_filter_nulls (("NoOrders",int_opt_to_json x.f_OrdListStatGrp_NoOrders) :: (("ClOrdID",string_opt_to_json x.f_OrdListStatGrp_ClOrdID) :: (("SecondaryClOrdID",string_opt_to_json x.f_OrdListStatGrp_SecondaryClOrdID) :: (("CumQty",float_4_opt_to_json x.f_OrdListStatGrp_CumQty) :: (("OrdStatus",ordstatus_opt_to_json x.f_OrdListStatGrp_OrdStatus) :: (("WorkingIndicator",workingindicator_opt_to_json x.f_OrdListStatGrp_WorkingIndicator) :: (("LeavesQty",float_4_opt_to_json x.f_OrdListStatGrp_LeavesQty) :: (("CxlQty",float_4_opt_to_json x.f_OrdListStatGrp_CxlQty) :: (("AvgPx",float_4_opt_to_json x.f_OrdListStatGrp_AvgPx) :: (("OrdRejReason",ordrejreason_opt_to_json x.f_OrdListStatGrp_OrdRejReason) :: (("Text",string_opt_to_json x.f_OrdListStatGrp_Text) :: (("EncodedTextLen",int_opt_to_json x.f_OrdListStatGrp_EncodedTextLen) :: (("EncodedText",string_opt_to_json x.f_OrdListStatGrp_EncodedText) :: [])))))))))))))
;;
...
let orderlistallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_OrderListAllocs_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_OrderListAllocs_AllocAccount) :: (("AllocShares",float_4_opt_to_json x.f_OrderListAllocs_AllocShares) :: [])))
;;
...
let orderqtydata_to_json (x)  : json =
    assoc_filter_nulls (("OrderQty",float_4_opt_to_json x.f_OrderQtyData_OrderQty) :: (("CashOrderQty",float_4_opt_to_json x.f_OrderQtyData_CashOrderQty) :: (("OrderPercent",float_4_opt_to_json x.f_OrderQtyData_OrderPercent) :: (("RoundingDirection",roundingdirection_opt_to_json x.f_OrderQtyData_RoundingDirection) :: (("RoundingModulus",float_opt_to_json x.f_OrderQtyData_RoundingModulus) :: [])))))
;;
...
let instrumentextension_to_json (x)  : json =
    assoc_filter_nulls (("DeliveryForm",deliveryform_opt_to_json x.f_InstrumentExtension_DeliveryForm) :: (("PctAtRisk",float_4_opt_to_json x.f_InstrumentExtension_PctAtRisk) :: (("AttrbGrp",rg_for_json attrbgrp_to_json x.f_InstrumentExtension_AttrbGrp) :: [])))
;;
...
let ordallocgrp_to_json (x)  : json =
    assoc_filter_nulls (("NoOrders",int_opt_to_json x.f_OrdAllocGrp_NoOrders) :: (("ClOrdID",string_opt_to_json x.f_OrdAllocGrp_ClOrdID) :: (("OrderID",string_opt_to_json x.f_OrdAllocGrp_OrderID) :: (("SecondaryOrderID",string_opt_to_json x.f_OrdAllocGrp_SecondaryOrderID) :: (("SecondaryClOrdID",string_opt_to_json x.f_OrdAllocGrp_SecondaryClOrdID) :: (("ListID",string_opt_to_json x.f_OrdAllocGrp_ListID) :: (("OrderQty",float_4_opt_to_json x.f_OrdAllocGrp_OrderQty) :: (("OrderAvgPx",float_4_opt_to_json x.f_OrdAllocGrp_OrderAvgPx) :: (("OrderBookingQty",float_4_opt_to_json x.f_OrdAllocGrp_OrderBookingQty) :: (("NestedParties2",rg_for_json nestedparties2_to_json x.f_OrdAllocGrp_NestedParties2) :: []))))))))))
;;
...
let legpreallocgrp_to_json (x)  : json =
    assoc_filter_nulls (("NoLegAllocs",int_opt_to_json x.f_LegPreAllocGrp_NoLegAllocs) :: (("LegAllocAccount",string_opt_to_json x.f_LegPreAllocGrp_LegAllocAccount) :: (("LegIndividualAllocID",string_opt_to_json x.f_LegPreAllocGrp_LegIndividualAllocID) :: (("LegAllocQty",float_4_opt_to_json x.f_LegPreAllocGrp_LegAllocQty) :: (("LegAllocAcctIDSource",string_opt_to_json x.f_LegPreAllocGrp_LegAllocAcctIDSource) :: (("LegSettlCurrency",currency_opt_to_json x.f_LegPreAllocGrp_LegSettlCurrency) :: (("NestedParties2",rg_for_json nestedparties2_to_json x.f_LegPreAllocGrp_NestedParties2) :: [])))))))
;;
...
let instrmtlegexecgrp_to_json (x)  : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_InstrmtLegExecGrp_InstrumentLeg) :: (("NoLegs",int_opt_to_json x.f_InstrmtLegExecGrp_NoLegs) :: (("LegQty",float_4_opt_to_json x.f_InstrmtLegExecGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_InstrmtLegExecGrp_LegSwapType) :: (("LegPositionEffect",char_opt_to_json x.f_InstrmtLegExecGrp_LegPositionEffect) :: (("LegCoveredOrUncovered",int_opt_to_json x.f_InstrmtLegExecGrp_LegCoveredOrUncovered) :: (("LegRefID",string_opt_to_json x.f_InstrmtLegExecGrp_LegRefID) :: (("LegPrice",float_4_opt_to_json x.f_InstrmtLegExecGrp_LegPrice) :: (("LegSettlType",char_opt_to_json x.f_InstrmtLegExecGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_InstrmtLegExecGrp_LegSettlDate) :: (("LegLastPx",float_4_opt_to_json x.f_InstrmtLegExecGrp_LegLastPx) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_InstrmtLegExecGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_InstrmtLegExecGrp_NestedParties) :: [])))))))))))))
;;
...
let preallocgrp_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_PreAllocGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_PreAllocGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_PreAllocGrp_AllocAcctIDSource) :: (("AllocSettlCurrency",currency_opt_to_json x.f_PreAllocGrp_AllocSettlCurrency) :: (("IndividualAllocID",string_opt_to_json x.f_PreAllocGrp_IndividualAllocID) :: (("AllocQty",float_4_opt_to_json x.f_PreAllocGrp_AllocQty) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_PreAllocGrp_NestedParties) :: [])))))))
;;
...
let legquotstatgrp_to_json (x)  : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_LegQuotStatGrp_InstrumentLeg) :: (("NoLegs",int_opt_to_json x.f_LegQuotStatGrp_NoLegs) :: (("LegQty",float_4_opt_to_json x.f_LegQuotStatGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_LegQuotStatGrp_LegSwapType) :: (("LegSettlType",char_opt_to_json x.f_LegQuotStatGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_LegQuotStatGrp_LegSettlDate) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_LegQuotStatGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_LegQuotStatGrp_NestedParties) :: []))))))))
;;
...
let quotreqlegsgrp_to_json (x)  : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_QuotReqLegsGrp_InstrumentLeg) :: (("LegBenchmarkCurveData",legbenchmarkcurvedata_to_json x.f_QuotReqLegsGrp_LegBenchmarkCurveData) :: (("NoLegs",int_opt_to_json x.f_QuotReqLegsGrp_NoLegs) :: (("LegQty",float_4_opt_to_json x.f_QuotReqLegsGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_QuotReqLegsGrp_LegSwapType) :: (("LegSettlType",char_opt_to_json x.f_QuotReqLegsGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_QuotReqLegsGrp_LegSettlDate) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_QuotReqLegsGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_QuotReqLegsGrp_NestedParties) :: [])))))))))
;;
...
let positionqty_to_json (x)  : json =
    assoc_filter_nulls (("NoPositions",int_opt_to_json x.f_PositionQty_NoPositions) :: (("PosType",postype_opt_to_json x.f_PositionQty_PosType) :: (("LongQty",float_4_opt_to_json x.f_PositionQty_LongQty) :: (("ShortQty",float_4_opt_to_json x.f_PositionQty_ShortQty) :: (("PosQtyStatus",posqtystatus_opt_to_json x.f_PositionQty_PosQtyStatus) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_PositionQty_NestedParties) :: []))))))
;;
...
let preallocmleggrp_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_PreAllocMlegGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_PreAllocMlegGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_PreAllocMlegGrp_AllocAcctIDSource) :: (("AllocSettlCurrency",currency_opt_to_json x.f_PreAllocMlegGrp_AllocSettlCurrency) :: (("IndividualAllocID",string_opt_to_json x.f_PreAllocMlegGrp_IndividualAllocID) :: (("AllocQty",float_4_opt_to_json x.f_PreAllocMlegGrp_AllocQty) :: (("NestedParties3",rg_for_json nestedparties3_to_json x.f_PreAllocMlegGrp_NestedParties3) :: [])))))))
;;
...
let quotentryackgrp_to_json (x)  : json =
    assoc_filter_nulls (("Instrument",instrument_to_json x.f_QuotEntryAckGrp_Instrument) :: (("NoQuoteEntries",int_opt_to_json x.f_QuotEntryAckGrp_NoQuoteEntries) :: (("QuoteEntryID",string_opt_to_json x.f_QuotEntryAckGrp_QuoteEntryID) :: (("BidPx",float_4_opt_to_json x.f_QuotEntryAckGrp_BidPx) :: (("OfferPx",float_4_opt_to_json x.f_QuotEntryAckGrp_OfferPx) :: (("BidSize",float_4_opt_to_json x.f_QuotEntryAckGrp_BidSize) :: (("OfferSize",float_4_opt_to_json x.f_QuotEntryAckGrp_OfferSize) :: (("ValidUntilTime",utctimestamp_opt_to_json x.f_QuotEntryAckGrp_ValidUntilTime) :: (("BidSpotRate",float_4_opt_to_json x.f_QuotEntryAckGrp_BidSpotRate) :: (("OfferSpotRate",float_4_opt_to_json x.f_QuotEntryAckGrp_OfferSpotRate) :: (("BidForwardPoints",float_4_opt_to_json x.f_QuotEntryAckGrp_BidForwardPoints) :: (("OfferForwardPoints",float_4_opt_to_json x.f_QuotEntryAckGrp_OfferForwardPoints) :: (("MidPx",float_4_opt_to_json x.f_QuotEntryAckGrp_MidPx) :: (("BidYield",float_4_opt_to_json x.f_QuotEntryAckGrp_BidYield) :: (("MidYield",float_4_opt_to_json x.f_QuotEntryAckGrp_MidYield) :: (("OfferYield",float_4_opt_to_json x.f_QuotEntryAckGrp_OfferYield) :: (("TransactTime",utctimestamp_opt_to_json x.f_QuotEntryAckGrp_TransactTime) :: (("TradingSessionID",string_opt_to_json x.f_QuotEntryAckGrp_TradingSessionID) :: (("TradingSessionSubID",string_opt_to_json x.f_QuotEntryAckGrp_TradingSessionSubID) :: (("SettlDate",localmktdate_opt_to_json x.f_QuotEntryAckGrp_SettlDate) :: (("OrdType",ordtype_opt_to_json x.f_QuotEntryAckGrp_OrdType) :: (("SettlDate2",localmktdate_opt_to_json x.f_QuotEntryAckGrp_SettlDate2) :: (("OrderQty2",float_4_opt_to_json x.f_QuotEntryAckGrp_OrderQty2) :: (("BidForwardPoints2",float_4_opt_to_json x.f_QuotEntryAckGrp_BidForwardPoints2) :: (("OfferForwardPoints2",float_4_opt_to_json x.f_QuotEntryAckGrp_OfferForwardPoints2) :: (("Currency",currency_opt_to_json x.f_QuotEntryAckGrp_Currency) :: (("QuoteEntryRejectReason",int_opt_to_json x.f_QuotEntryAckGrp_QuoteEntryRejectReason) :: (("InstrmtLegGrp",rg_for_json instrmtleggrp_to_json x.f_QuotEntryAckGrp_InstrmtLegGrp) :: []))))))))))))))))))))))))))))
;;
...
let quotentrygrp_to_json (x)  : json =
    assoc_filter_nulls (("Instrument",instrument_to_json x.f_QuotEntryGrp_Instrument) :: (("NoQuoteEntries",int_opt_to_json x.f_QuotEntryGrp_NoQuoteEntries) :: (("QuoteEntryID",string_opt_to_json x.f_QuotEntryGrp_QuoteEntryID) :: (("BidPx",float_4_opt_to_json x.f_QuotEntryGrp_BidPx) :: (("OfferPx",float_4_opt_to_json x.f_QuotEntryGrp_OfferPx) :: (("BidSize",float_4_opt_to_json x.f_QuotEntryGrp_BidSize) :: (("OfferSize",float_4_opt_to_json x.f_QuotEntryGrp_OfferSize) :: (("ValidUntilTime",utctimestamp_opt_to_json x.f_QuotEntryGrp_ValidUntilTime) :: (("BidSpotRate",float_4_opt_to_json x.f_QuotEntryGrp_BidSpotRate) :: (("OfferSpotRate",float_4_opt_to_json x.f_QuotEntryGrp_OfferSpotRate) :: (("BidForwardPoints",float_4_opt_to_json x.f_QuotEntryGrp_BidForwardPoints) :: (("OfferForwardPoints",float_4_opt_to_json x.f_QuotEntryGrp_OfferForwardPoints) :: (("MidPx",float_4_opt_to_json x.f_QuotEntryGrp_MidPx) :: (("BidYield",float_4_opt_to_json x.f_QuotEntryGrp_BidYield) :: (("MidYield",float_4_opt_to_json x.f_QuotEntryGrp_MidYield) :: (("OfferYield",float_4_opt_to_json x.f_QuotEntryGrp_OfferYield) :: (("TransactTime",utctimestamp_opt_to_json x.f_QuotEntryGrp_TransactTime) :: (("TradingSessionID",string_opt_to_json x.f_QuotEntryGrp_TradingSessionID) :: (("TradingSessionSubID",string_opt_to_json x.f_QuotEntryGrp_TradingSessionSubID) :: (("SettlDate",localmktdate_opt_to_json x.f_QuotEntryGrp_SettlDate) :: (("OrdType",ordtype_opt_to_json x.f_QuotEntryGrp_OrdType) :: (("SettlDate2",localmktdate_opt_to_json x.f_QuotEntryGrp_SettlDate2) :: (("OrderQty2",float_4_opt_to_json x.f_QuotEntryGrp_OrderQty2) :: (("BidForwardPoints2",float_4_opt_to_json x.f_QuotEntryGrp_BidForwardPoints2) :: (("OfferForwardPoints2",float_4_opt_to_json x.f_QuotEntryGrp_OfferForwardPoints2) :: (("Currency",currency_opt_to_json x.f_QuotEntryGrp_Currency) :: (("InstrmtLegGrp",rg_for_json instrmtleggrp_to_json x.f_QuotEntryGrp_InstrmtLegGrp) :: [])))))))))))))))))))))))))))
;;
...
let allocgrp_to_json (x)  : json =
    assoc_filter_nulls (("CommissionData",commissiondata_to_json x.f_AllocGrp_CommissionData) :: (("SettlInstructionsData",settlinstructionsdata_to_json x.f_AllocGrp_SettlInstructionsData) :: (("NoAllocs",int_opt_to_json x.f_AllocGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_AllocGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_AllocGrp_AllocAcctIDSource) :: (("MatchStatus",matchstatus_opt_to_json x.f_AllocGrp_MatchStatus) :: (("AllocPrice",float_4_opt_to_json x.f_AllocGrp_AllocPrice) :: (("AllocQty",float_4_opt_to_json x.f_AllocGrp_AllocQty) :: (("IndividualAllocID",string_opt_to_json x.f_AllocGrp_IndividualAllocID) :: (("ProcessCode",processcode_opt_to_json x.f_AllocGrp_ProcessCode) :: (("NotifyBrokerOfCredit",notifybrokerofcredit_opt_to_json x.f_AllocGrp_NotifyBrokerOfCredit) :: (("AllocHandlInst",allochandlinst_opt_to_json x.f_AllocGrp_AllocHandlInst) :: (("AllocText",string_opt_to_json x.f_AllocGrp_AllocText) :: (("EncodedAllocTextLen",int_opt_to_json x.f_AllocGrp_EncodedAllocTextLen) :: (("EncodedAllocText",string_opt_to_json x.f_AllocGrp_EncodedAllocText) :: (("AllocAvgPx",float_4_opt_to_json x.f_AllocGrp_AllocAvgPx) :: (("AllocNetMoney",float_4_opt_to_json x.f_AllocGrp_AllocNetMoney) :: (("SettlCurrAmt",float_4_opt_to_json x.f_AllocGrp_SettlCurrAmt) :: (("AllocSettlCurrAmt",float_4_opt_to_json x.f_AllocGrp_AllocSettlCurrAmt) :: (("SettlCurrency",currency_opt_to_json x.f_AllocGrp_SettlCurrency) :: (("AllocSettlCurrency",currency_opt_to_json x.f_AllocGrp_AllocSettlCurrency) :: (("SettlCurrFxRate",float_opt_to_json x.f_AllocGrp_SettlCurrFxRate) :: (("SettlCurrFxRateCalc",settlcurrfxratecalc_opt_to_json x.f_AllocGrp_SettlCurrFxRateCalc) :: (("AllocAccruedInterestAmt",float_4_opt_to_json x.f_AllocGrp_AllocAccruedInterestAmt) :: (("AllocInterestAtMaturity",float_4_opt_to_json x.f_AllocGrp_AllocInterestAtMaturity) :: (("AllocSettlInstType",allocsettlinsttype_opt_to_json x.f_AllocGrp_AllocSettlInstType) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_AllocGrp_NestedParties) :: (("MiscFeesGrp",rg_for_json miscfeesgrp_to_json x.f_AllocGrp_MiscFeesGrp) :: (("ClrInstGrp",rg_for_json clrinstgrp_to_json x.f_AllocGrp_ClrInstGrp) :: [])))))))))))))))))))))))))))))
;;
