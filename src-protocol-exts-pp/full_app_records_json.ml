...
let legbenchmarkcurvedata_to_json ( x ) : json =
    assoc_filter_nulls (("LegBenchmarkCurveCurrency",currency_opt_to_json x.f_LegBenchmarkCurveData_LegBenchmarkCurveCurrency) :: (("LegBenchmarkCurveName",string_opt_to_json x.f_LegBenchmarkCurveData_LegBenchmarkCurveName) :: (("LegBenchmarkCurvePoint",string_opt_to_json x.f_LegBenchmarkCurveData_LegBenchmarkCurvePoint) :: (("LegBenchmarkPrice",float_opt_to_json x.f_LegBenchmarkCurveData_LegBenchmarkPrice) :: (("LegBenchmarkPriceType",int_opt_to_json x.f_LegBenchmarkCurveData_LegBenchmarkPriceType) :: [])))))
;;
...
let allocackgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_AllocAckGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_AllocAckGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_AllocAckGrp_AllocAcctIDSource) :: (("AllocPrice",float_opt_to_json x.f_AllocAckGrp_AllocPrice) :: (("IndividualAllocID",string_opt_to_json x.f_AllocAckGrp_IndividualAllocID) :: (("IndividualAllocRejCode",int_opt_to_json x.f_AllocAckGrp_IndividualAllocRejCode) :: (("AllocText",string_opt_to_json x.f_AllocAckGrp_AllocText) :: (("EncodedAllocTextLen",int_opt_to_json x.f_AllocAckGrp_EncodedAllocTextLen) :: (("EncodedAllocText",string_opt_to_json x.f_AllocAckGrp_EncodedAllocText) :: [])))))))))
;;
...
let ordliststatgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoOrders",int_opt_to_json x.f_OrdListStatGrp_NoOrders) :: (("ClOrdID",string_opt_to_json x.f_OrdListStatGrp_ClOrdID) :: (("SecondaryClOrdID",string_opt_to_json x.f_OrdListStatGrp_SecondaryClOrdID) :: (("CumQty",float_opt_to_json x.f_OrdListStatGrp_CumQty) :: (("OrdStatus",ordstatus_opt_to_json x.f_OrdListStatGrp_OrdStatus) :: (("WorkingIndicator",workingindicator_opt_to_json x.f_OrdListStatGrp_WorkingIndicator) :: (("LeavesQty",float_opt_to_json x.f_OrdListStatGrp_LeavesQty) :: (("CxlQty",float_opt_to_json x.f_OrdListStatGrp_CxlQty) :: (("AvgPx",float_opt_to_json x.f_OrdListStatGrp_AvgPx) :: (("OrdRejReason",ordrejreason_opt_to_json x.f_OrdListStatGrp_OrdRejReason) :: (("Text",string_opt_to_json x.f_OrdListStatGrp_Text) :: (("EncodedTextLen",int_opt_to_json x.f_OrdListStatGrp_EncodedTextLen) :: (("EncodedText",string_opt_to_json x.f_OrdListStatGrp_EncodedText) :: [])))))))))))))
;;
...
let evntgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoEvents",int_opt_to_json x.f_EvntGrp_NoEvents) :: (("EventType",eventtype_opt_to_json x.f_EvntGrp_EventType) :: (("EventDate",localmktdate_opt_to_json x.f_EvntGrp_EventDate) :: (("EventPx",float_opt_to_json x.f_EvntGrp_EventPx) :: (("EventText",string_opt_to_json x.f_EvntGrp_EventText) :: [])))))
;;
...
let execallocgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoExecs",int_opt_to_json x.f_ExecAllocGrp_NoExecs) :: (("LastQty",float_opt_to_json x.f_ExecAllocGrp_LastQty) :: (("ExecID",string_opt_to_json x.f_ExecAllocGrp_ExecID) :: (("SecondaryExecID",string_opt_to_json x.f_ExecAllocGrp_SecondaryExecID) :: (("LastPx",float_opt_to_json x.f_ExecAllocGrp_LastPx) :: (("LastParPx",float_opt_to_json x.f_ExecAllocGrp_LastParPx) :: (("LastCapacity",lastcapacity_opt_to_json x.f_ExecAllocGrp_LastCapacity) :: [])))))))
;;
...
let commissiondata_to_json ( x ) : json =
    assoc_filter_nulls (("Commission",float_opt_to_json x.f_CommissionData_Commission) :: (("CommType",commtype_opt_to_json x.f_CommissionData_CommType) :: (("CommCurrency",currency_opt_to_json x.f_CommissionData_CommCurrency) :: (("FundRenewWaiv",fundrenewwaiv_opt_to_json x.f_CommissionData_FundRenewWaiv) :: []))))
;;
...
let miscfeesgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoMiscFees",int_opt_to_json x.f_MiscFeesGrp_NoMiscFees) :: (("MiscFeeAmt",float_opt_to_json x.f_MiscFeesGrp_MiscFeeAmt) :: (("MiscFeeCurr",currency_opt_to_json x.f_MiscFeesGrp_MiscFeeCurr) :: (("MiscFeeType",miscfeetype_opt_to_json x.f_MiscFeesGrp_MiscFeeType) :: (("MiscFeeBasis",miscfeebasis_opt_to_json x.f_MiscFeesGrp_MiscFeeBasis) :: [])))))
;;
...
let cpctyconfgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoCapacities",int_opt_to_json x.f_CpctyConfGrp_NoCapacities) :: (("OrderCapacity",ordercapacity_opt_to_json x.f_CpctyConfGrp_OrderCapacity) :: (("OrderRestrictions",orderrestrictions_opt_to_json x.f_CpctyConfGrp_OrderRestrictions) :: (("OrderCapacityQty",float_opt_to_json x.f_CpctyConfGrp_OrderCapacityQty) :: []))))
;;
...
let positionamountdata_to_json ( x ) : json =
    assoc_filter_nulls (("NoPosAmt",int_opt_to_json x.f_PositionAmountData_NoPosAmt) :: (("PosAmtType",posamttype_opt_to_json x.f_PositionAmountData_PosAmtType) :: (("PosAmt",float_opt_to_json x.f_PositionAmountData_PosAmt) :: [])))
;;
...
let orderqtydata_to_json ( x ) : json =
    assoc_filter_nulls (("OrderQty",float_opt_to_json x.f_OrderQtyData_OrderQty) :: (("CashOrderQty",float_opt_to_json x.f_OrderQtyData_CashOrderQty) :: (("OrderPercent",float_opt_to_json x.f_OrderQtyData_OrderPercent) :: (("RoundingDirection",roundingdirection_opt_to_json x.f_OrderQtyData_RoundingDirection) :: (("RoundingModulus",float_opt_to_json x.f_OrderQtyData_RoundingModulus) :: [])))))
;;
...
let biddescreqgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoBidDescriptors",int_opt_to_json x.f_BidDescReqGrp_NoBidDescriptors) :: (("BidDescriptorType",biddescriptortype_opt_to_json x.f_BidDescReqGrp_BidDescriptorType) :: (("BidDescriptor",string_opt_to_json x.f_BidDescReqGrp_BidDescriptor) :: (("SideValueInd",sidevalueind_opt_to_json x.f_BidDescReqGrp_SideValueInd) :: (("LiquidityValue",float_opt_to_json x.f_BidDescReqGrp_LiquidityValue) :: (("LiquidityNumSecurities",int_opt_to_json x.f_BidDescReqGrp_LiquidityNumSecurities) :: (("LiquidityPctLow",float_opt_to_json x.f_BidDescReqGrp_LiquidityPctLow) :: (("LiquidityPctHigh",float_opt_to_json x.f_BidDescReqGrp_LiquidityPctHigh) :: (("EFPTrackingError",float_opt_to_json x.f_BidDescReqGrp_EFPTrackingError) :: (("FairValue",float_opt_to_json x.f_BidDescReqGrp_FairValue) :: (("OutsideIndexPct",float_opt_to_json x.f_BidDescReqGrp_OutsideIndexPct) :: (("ValueOfFutures",float_opt_to_json x.f_BidDescReqGrp_ValueOfFutures) :: []))))))))))))
;;
...
let yielddata_to_json ( x ) : json =
    assoc_filter_nulls (("YieldType",yieldtype_opt_to_json x.f_YieldData_YieldType) :: (("Yield",float_opt_to_json x.f_YieldData_Yield) :: (("YieldCalcDate",localmktdate_opt_to_json x.f_YieldData_YieldCalcDate) :: (("YieldRedemptionDate",localmktdate_opt_to_json x.f_YieldData_YieldRedemptionDate) :: (("YieldRedemptionPrice",float_opt_to_json x.f_YieldData_YieldRedemptionPrice) :: (("YieldRedemptionPriceType",int_opt_to_json x.f_YieldData_YieldRedemptionPriceType) :: []))))))
;;
...
let instrumentextension_to_json ( x ) : json =
    assoc_filter_nulls (("DeliveryForm",deliveryform_opt_to_json x.f_InstrumentExtension_DeliveryForm) :: (("PctAtRisk",float_opt_to_json x.f_InstrumentExtension_PctAtRisk) :: (("AttrbGrp",rg_for_json attrbgrp_to_json x.f_InstrumentExtension_AttrbGrp) :: [])))
;;
...
let bidcomprspgrp_to_json ( x ) : json =
    assoc_filter_nulls (("CommissionData",commissiondata_to_json x.f_BidCompRspGrp_CommissionData) :: (("NoBidComponents",int_opt_to_json x.f_BidCompRspGrp_NoBidComponents) :: (("ListID",string_opt_to_json x.f_BidCompRspGrp_ListID) :: (("Country",country_opt_to_json x.f_BidCompRspGrp_Country) :: (("Side",side_opt_to_json x.f_BidCompRspGrp_Side) :: (("Price",float_opt_to_json x.f_BidCompRspGrp_Price) :: (("PriceType",pricetype_opt_to_json x.f_BidCompRspGrp_PriceType) :: (("FairValue",float_opt_to_json x.f_BidCompRspGrp_FairValue) :: (("NetGrossInd",netgrossind_opt_to_json x.f_BidCompRspGrp_NetGrossInd) :: (("SettlType",settltype_opt_to_json x.f_BidCompRspGrp_SettlType) :: (("SettlDate",localmktdate_opt_to_json x.f_BidCompRspGrp_SettlDate) :: (("TradingSessionID",string_opt_to_json x.f_BidCompRspGrp_TradingSessionID) :: (("TradingSessionSubID",string_opt_to_json x.f_BidCompRspGrp_TradingSessionSubID) :: (("Text",string_opt_to_json x.f_BidCompRspGrp_Text) :: (("EncodedTextLen",int_opt_to_json x.f_BidCompRspGrp_EncodedTextLen) :: (("EncodedText",string_opt_to_json x.f_BidCompRspGrp_EncodedText) :: []))))))))))))))))
;;
...
let parties_to_json ( x ) : json =
    assoc_filter_nulls (("NoPartyIDs",int_opt_to_json x.f_Parties_NoPartyIDs) :: (("PartyID",string_opt_to_json x.f_Parties_PartyID) :: (("PartyIDSource",partyidsource_opt_to_json x.f_Parties_PartyIDSource) :: (("PartyRole",partyrole_opt_to_json x.f_Parties_PartyRole) :: (("PtysSubGrp",rg_for_json ptyssubgrp_to_json x.f_Parties_PtysSubGrp) :: [])))))
;;
...
let undinstrmtstrkpxgrp_to_json ( x ) : json =
    assoc_filter_nulls (("UnderlyingInstrument",underlyinginstrument_to_json x.f_UndInstrmtStrkPxGrp_UnderlyingInstrument) :: (("NoUnderlyings",int_opt_to_json x.f_UndInstrmtStrkPxGrp_NoUnderlyings) :: (("PrevClosePx",float_opt_to_json x.f_UndInstrmtStrkPxGrp_PrevClosePx) :: (("ClOrdID",string_opt_to_json x.f_UndInstrmtStrkPxGrp_ClOrdID) :: (("SecondaryClOrdID",string_opt_to_json x.f_UndInstrmtStrkPxGrp_SecondaryClOrdID) :: (("Side",side_opt_to_json x.f_UndInstrmtStrkPxGrp_Side) :: (("Price",float_opt_to_json x.f_UndInstrmtStrkPxGrp_Price) :: (("Currency",currency_opt_to_json x.f_UndInstrmtStrkPxGrp_Currency) :: (("Text",string_opt_to_json x.f_UndInstrmtStrkPxGrp_Text) :: (("EncodedTextLen",int_opt_to_json x.f_UndInstrmtStrkPxGrp_EncodedTextLen) :: (("EncodedText",string_opt_to_json x.f_UndInstrmtStrkPxGrp_EncodedText) :: [])))))))))))
;;
...
let quotreqlegsgrp_to_json ( x ) : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_QuotReqLegsGrp_InstrumentLeg) :: (("LegBenchmarkCurveData",legbenchmarkcurvedata_to_json x.f_QuotReqLegsGrp_LegBenchmarkCurveData) :: (("NoLegs",int_opt_to_json x.f_QuotReqLegsGrp_NoLegs) :: (("LegQty",float_opt_to_json x.f_QuotReqLegsGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_QuotReqLegsGrp_LegSwapType) :: (("LegSettlType",char_opt_to_json x.f_QuotReqLegsGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_QuotReqLegsGrp_LegSettlDate) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_QuotReqLegsGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_QuotReqLegsGrp_NestedParties) :: [])))))))))
;;
...
let legquotgrp_to_json ( x ) : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_LegQuotGrp_InstrumentLeg) :: (("LegBenchmarkCurveData",legbenchmarkcurvedata_to_json x.f_LegQuotGrp_LegBenchmarkCurveData) :: (("NoLegs",int_opt_to_json x.f_LegQuotGrp_NoLegs) :: (("LegQty",float_opt_to_json x.f_LegQuotGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_LegQuotGrp_LegSwapType) :: (("LegSettlType",char_opt_to_json x.f_LegQuotGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_LegQuotGrp_LegSettlDate) :: (("LegPriceType",int_opt_to_json x.f_LegQuotGrp_LegPriceType) :: (("LegBidPx",float_opt_to_json x.f_LegQuotGrp_LegBidPx) :: (("LegOfferPx",float_opt_to_json x.f_LegQuotGrp_LegOfferPx) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_LegQuotGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_LegQuotGrp_NestedParties) :: []))))))))))))
;;
...
let trdinstrmtleggrp_to_json ( x ) : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_TrdInstrmtLegGrp_InstrumentLeg) :: (("NoLegs",int_opt_to_json x.f_TrdInstrmtLegGrp_NoLegs) :: (("LegQty",float_opt_to_json x.f_TrdInstrmtLegGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_TrdInstrmtLegGrp_LegSwapType) :: (("LegPositionEffect",char_opt_to_json x.f_TrdInstrmtLegGrp_LegPositionEffect) :: (("LegCoveredOrUncovered",int_opt_to_json x.f_TrdInstrmtLegGrp_LegCoveredOrUncovered) :: (("LegRefID",string_opt_to_json x.f_TrdInstrmtLegGrp_LegRefID) :: (("LegPrice",float_opt_to_json x.f_TrdInstrmtLegGrp_LegPrice) :: (("LegSettlType",char_opt_to_json x.f_TrdInstrmtLegGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_TrdInstrmtLegGrp_LegSettlDate) :: (("LegLastPx",float_opt_to_json x.f_TrdInstrmtLegGrp_LegLastPx) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_TrdInstrmtLegGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_TrdInstrmtLegGrp_NestedParties) :: [])))))))))))))
;;
...
let instrmtlegexecgrp_to_json ( x ) : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_InstrmtLegExecGrp_InstrumentLeg) :: (("NoLegs",int_opt_to_json x.f_InstrmtLegExecGrp_NoLegs) :: (("LegQty",float_opt_to_json x.f_InstrmtLegExecGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_InstrmtLegExecGrp_LegSwapType) :: (("LegPositionEffect",char_opt_to_json x.f_InstrmtLegExecGrp_LegPositionEffect) :: (("LegCoveredOrUncovered",int_opt_to_json x.f_InstrmtLegExecGrp_LegCoveredOrUncovered) :: (("LegRefID",string_opt_to_json x.f_InstrmtLegExecGrp_LegRefID) :: (("LegPrice",float_opt_to_json x.f_InstrmtLegExecGrp_LegPrice) :: (("LegSettlType",char_opt_to_json x.f_InstrmtLegExecGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_InstrmtLegExecGrp_LegSettlDate) :: (("LegLastPx",float_opt_to_json x.f_InstrmtLegExecGrp_LegLastPx) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_InstrmtLegExecGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_InstrmtLegExecGrp_NestedParties) :: [])))))))))))))
;;
...
let positionqty_to_json ( x ) : json =
    assoc_filter_nulls (("NoPositions",int_opt_to_json x.f_PositionQty_NoPositions) :: (("PosType",postype_opt_to_json x.f_PositionQty_PosType) :: (("LongQty",float_opt_to_json x.f_PositionQty_LongQty) :: (("ShortQty",float_opt_to_json x.f_PositionQty_ShortQty) :: (("PosQtyStatus",posqtystatus_opt_to_json x.f_PositionQty_PosQtyStatus) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_PositionQty_NestedParties) :: []))))))
;;
...
let preallocgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_PreAllocGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_PreAllocGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_PreAllocGrp_AllocAcctIDSource) :: (("AllocSettlCurrency",currency_opt_to_json x.f_PreAllocGrp_AllocSettlCurrency) :: (("IndividualAllocID",string_opt_to_json x.f_PreAllocGrp_IndividualAllocID) :: (("AllocQty",float_opt_to_json x.f_PreAllocGrp_AllocQty) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_PreAllocGrp_NestedParties) :: [])))))))
;;
...
let legquotstatgrp_to_json ( x ) : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_LegQuotStatGrp_InstrumentLeg) :: (("NoLegs",int_opt_to_json x.f_LegQuotStatGrp_NoLegs) :: (("LegQty",float_opt_to_json x.f_LegQuotStatGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_LegQuotStatGrp_LegSwapType) :: (("LegSettlType",char_opt_to_json x.f_LegQuotStatGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_LegQuotStatGrp_LegSettlDate) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_LegQuotStatGrp_LegStipulations) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_LegQuotStatGrp_NestedParties) :: []))))))))
;;
...
let ordallocgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoOrders",int_opt_to_json x.f_OrdAllocGrp_NoOrders) :: (("ClOrdID",string_opt_to_json x.f_OrdAllocGrp_ClOrdID) :: (("OrderID",string_opt_to_json x.f_OrdAllocGrp_OrderID) :: (("SecondaryOrderID",string_opt_to_json x.f_OrdAllocGrp_SecondaryOrderID) :: (("SecondaryClOrdID",string_opt_to_json x.f_OrdAllocGrp_SecondaryClOrdID) :: (("ListID",string_opt_to_json x.f_OrdAllocGrp_ListID) :: (("OrderQty",float_opt_to_json x.f_OrdAllocGrp_OrderQty) :: (("OrderAvgPx",float_opt_to_json x.f_OrdAllocGrp_OrderAvgPx) :: (("OrderBookingQty",float_opt_to_json x.f_OrdAllocGrp_OrderBookingQty) :: (("NestedParties2",rg_for_json nestedparties2_to_json x.f_OrdAllocGrp_NestedParties2) :: []))))))))))
;;
...
let legpreallocgrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoLegAllocs",int_opt_to_json x.f_LegPreAllocGrp_NoLegAllocs) :: (("LegAllocAccount",string_opt_to_json x.f_LegPreAllocGrp_LegAllocAccount) :: (("LegIndividualAllocID",string_opt_to_json x.f_LegPreAllocGrp_LegIndividualAllocID) :: (("LegAllocQty",float_opt_to_json x.f_LegPreAllocGrp_LegAllocQty) :: (("LegAllocAcctIDSource",string_opt_to_json x.f_LegPreAllocGrp_LegAllocAcctIDSource) :: (("LegSettlCurrency",currency_opt_to_json x.f_LegPreAllocGrp_LegSettlCurrency) :: (("NestedParties2",rg_for_json nestedparties2_to_json x.f_LegPreAllocGrp_NestedParties2) :: [])))))))
;;
...
let preallocmleggrp_to_json ( x ) : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_PreAllocMlegGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_PreAllocMlegGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_PreAllocMlegGrp_AllocAcctIDSource) :: (("AllocSettlCurrency",currency_opt_to_json x.f_PreAllocMlegGrp_AllocSettlCurrency) :: (("IndividualAllocID",string_opt_to_json x.f_PreAllocMlegGrp_IndividualAllocID) :: (("AllocQty",float_opt_to_json x.f_PreAllocMlegGrp_AllocQty) :: (("NestedParties3",rg_for_json nestedparties3_to_json x.f_PreAllocMlegGrp_NestedParties3) :: [])))))))
;;
...
let legordgrp_to_json ( x ) : json =
    assoc_filter_nulls (("InstrumentLeg",instrumentleg_to_json x.f_LegOrdGrp_InstrumentLeg) :: (("NoLegs",int_opt_to_json x.f_LegOrdGrp_NoLegs) :: (("LegQty",float_opt_to_json x.f_LegOrdGrp_LegQty) :: (("LegSwapType",legswaptype_opt_to_json x.f_LegOrdGrp_LegSwapType) :: (("LegPositionEffect",char_opt_to_json x.f_LegOrdGrp_LegPositionEffect) :: (("LegCoveredOrUncovered",int_opt_to_json x.f_LegOrdGrp_LegCoveredOrUncovered) :: (("LegRefID",string_opt_to_json x.f_LegOrdGrp_LegRefID) :: (("LegPrice",float_opt_to_json x.f_LegOrdGrp_LegPrice) :: (("LegSettlType",char_opt_to_json x.f_LegOrdGrp_LegSettlType) :: (("LegSettlDate",localmktdate_opt_to_json x.f_LegOrdGrp_LegSettlDate) :: (("LegStipulations",rg_for_json legstipulations_to_json x.f_LegOrdGrp_LegStipulations) :: (("LegPreAllocGrp",rg_for_json legpreallocgrp_to_json x.f_LegOrdGrp_LegPreAllocGrp) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_LegOrdGrp_NestedParties) :: [])))))))))))))
;;
...
let quotentryackgrp_to_json ( x ) : json =
    assoc_filter_nulls (("Instrument",instrument_to_json x.f_QuotEntryAckGrp_Instrument) :: (("NoQuoteEntries",int_opt_to_json x.f_QuotEntryAckGrp_NoQuoteEntries) :: (("QuoteEntryID",string_opt_to_json x.f_QuotEntryAckGrp_QuoteEntryID) :: (("BidPx",float_opt_to_json x.f_QuotEntryAckGrp_BidPx) :: (("OfferPx",float_opt_to_json x.f_QuotEntryAckGrp_OfferPx) :: (("BidSize",float_opt_to_json x.f_QuotEntryAckGrp_BidSize) :: (("OfferSize",float_opt_to_json x.f_QuotEntryAckGrp_OfferSize) :: (("ValidUntilTime",utctimestamp_opt_to_json x.f_QuotEntryAckGrp_ValidUntilTime) :: (("BidSpotRate",float_opt_to_json x.f_QuotEntryAckGrp_BidSpotRate) :: (("OfferSpotRate",float_opt_to_json x.f_QuotEntryAckGrp_OfferSpotRate) :: (("BidForwardPoints",float_opt_to_json x.f_QuotEntryAckGrp_BidForwardPoints) :: (("OfferForwardPoints",float_opt_to_json x.f_QuotEntryAckGrp_OfferForwardPoints) :: (("MidPx",float_opt_to_json x.f_QuotEntryAckGrp_MidPx) :: (("BidYield",float_opt_to_json x.f_QuotEntryAckGrp_BidYield) :: (("MidYield",float_opt_to_json x.f_QuotEntryAckGrp_MidYield) :: (("OfferYield",float_opt_to_json x.f_QuotEntryAckGrp_OfferYield) :: (("TransactTime",utctimestamp_opt_to_json x.f_QuotEntryAckGrp_TransactTime) :: (("TradingSessionID",string_opt_to_json x.f_QuotEntryAckGrp_TradingSessionID) :: (("TradingSessionSubID",string_opt_to_json x.f_QuotEntryAckGrp_TradingSessionSubID) :: (("SettlDate",localmktdate_opt_to_json x.f_QuotEntryAckGrp_SettlDate) :: (("OrdType",ordtype_opt_to_json x.f_QuotEntryAckGrp_OrdType) :: (("SettlDate2",localmktdate_opt_to_json x.f_QuotEntryAckGrp_SettlDate2) :: (("OrderQty2",float_opt_to_json x.f_QuotEntryAckGrp_OrderQty2) :: (("BidForwardPoints2",float_opt_to_json x.f_QuotEntryAckGrp_BidForwardPoints2) :: (("OfferForwardPoints2",float_opt_to_json x.f_QuotEntryAckGrp_OfferForwardPoints2) :: (("Currency",currency_opt_to_json x.f_QuotEntryAckGrp_Currency) :: (("QuoteEntryRejectReason",int_opt_to_json x.f_QuotEntryAckGrp_QuoteEntryRejectReason) :: (("InstrmtLegGrp",rg_for_json instrmtleggrp_to_json x.f_QuotEntryAckGrp_InstrmtLegGrp) :: []))))))))))))))))))))))))))))
;;
...
let quotentrygrp_to_json ( x ) : json =
    assoc_filter_nulls (("Instrument",instrument_to_json x.f_QuotEntryGrp_Instrument) :: (("NoQuoteEntries",int_opt_to_json x.f_QuotEntryGrp_NoQuoteEntries) :: (("QuoteEntryID",string_opt_to_json x.f_QuotEntryGrp_QuoteEntryID) :: (("BidPx",float_opt_to_json x.f_QuotEntryGrp_BidPx) :: (("OfferPx",float_opt_to_json x.f_QuotEntryGrp_OfferPx) :: (("BidSize",float_opt_to_json x.f_QuotEntryGrp_BidSize) :: (("OfferSize",float_opt_to_json x.f_QuotEntryGrp_OfferSize) :: (("ValidUntilTime",utctimestamp_opt_to_json x.f_QuotEntryGrp_ValidUntilTime) :: (("BidSpotRate",float_opt_to_json x.f_QuotEntryGrp_BidSpotRate) :: (("OfferSpotRate",float_opt_to_json x.f_QuotEntryGrp_OfferSpotRate) :: (("BidForwardPoints",float_opt_to_json x.f_QuotEntryGrp_BidForwardPoints) :: (("OfferForwardPoints",float_opt_to_json x.f_QuotEntryGrp_OfferForwardPoints) :: (("MidPx",float_opt_to_json x.f_QuotEntryGrp_MidPx) :: (("BidYield",float_opt_to_json x.f_QuotEntryGrp_BidYield) :: (("MidYield",float_opt_to_json x.f_QuotEntryGrp_MidYield) :: (("OfferYield",float_opt_to_json x.f_QuotEntryGrp_OfferYield) :: (("TransactTime",utctimestamp_opt_to_json x.f_QuotEntryGrp_TransactTime) :: (("TradingSessionID",string_opt_to_json x.f_QuotEntryGrp_TradingSessionID) :: (("TradingSessionSubID",string_opt_to_json x.f_QuotEntryGrp_TradingSessionSubID) :: (("SettlDate",localmktdate_opt_to_json x.f_QuotEntryGrp_SettlDate) :: (("OrdType",ordtype_opt_to_json x.f_QuotEntryGrp_OrdType) :: (("SettlDate2",localmktdate_opt_to_json x.f_QuotEntryGrp_SettlDate2) :: (("OrderQty2",float_opt_to_json x.f_QuotEntryGrp_OrderQty2) :: (("BidForwardPoints2",float_opt_to_json x.f_QuotEntryGrp_BidForwardPoints2) :: (("OfferForwardPoints2",float_opt_to_json x.f_QuotEntryGrp_OfferForwardPoints2) :: (("Currency",currency_opt_to_json x.f_QuotEntryGrp_Currency) :: (("InstrmtLegGrp",rg_for_json instrmtleggrp_to_json x.f_QuotEntryGrp_InstrmtLegGrp) :: [])))))))))))))))))))))))))))
;;
...
let allocgrp_to_json ( x ) : json =
    assoc_filter_nulls (("CommissionData",commissiondata_to_json x.f_AllocGrp_CommissionData) :: (("SettlInstructionsData",settlinstructionsdata_to_json x.f_AllocGrp_SettlInstructionsData) :: (("NoAllocs",int_opt_to_json x.f_AllocGrp_NoAllocs) :: (("AllocAccount",string_opt_to_json x.f_AllocGrp_AllocAccount) :: (("AllocAcctIDSource",int_opt_to_json x.f_AllocGrp_AllocAcctIDSource) :: (("MatchStatus",matchstatus_opt_to_json x.f_AllocGrp_MatchStatus) :: (("AllocPrice",float_opt_to_json x.f_AllocGrp_AllocPrice) :: (("AllocQty",float_opt_to_json x.f_AllocGrp_AllocQty) :: (("IndividualAllocID",string_opt_to_json x.f_AllocGrp_IndividualAllocID) :: (("ProcessCode",processcode_opt_to_json x.f_AllocGrp_ProcessCode) :: (("NotifyBrokerOfCredit",notifybrokerofcredit_opt_to_json x.f_AllocGrp_NotifyBrokerOfCredit) :: (("AllocHandlInst",allochandlinst_opt_to_json x.f_AllocGrp_AllocHandlInst) :: (("AllocText",string_opt_to_json x.f_AllocGrp_AllocText) :: (("EncodedAllocTextLen",int_opt_to_json x.f_AllocGrp_EncodedAllocTextLen) :: (("EncodedAllocText",string_opt_to_json x.f_AllocGrp_EncodedAllocText) :: (("AllocAvgPx",float_opt_to_json x.f_AllocGrp_AllocAvgPx) :: (("AllocNetMoney",float_opt_to_json x.f_AllocGrp_AllocNetMoney) :: (("SettlCurrAmt",float_opt_to_json x.f_AllocGrp_SettlCurrAmt) :: (("AllocSettlCurrAmt",float_opt_to_json x.f_AllocGrp_AllocSettlCurrAmt) :: (("SettlCurrency",currency_opt_to_json x.f_AllocGrp_SettlCurrency) :: (("AllocSettlCurrency",currency_opt_to_json x.f_AllocGrp_AllocSettlCurrency) :: (("SettlCurrFxRate",float_opt_to_json x.f_AllocGrp_SettlCurrFxRate) :: (("SettlCurrFxRateCalc",settlcurrfxratecalc_opt_to_json x.f_AllocGrp_SettlCurrFxRateCalc) :: (("AllocAccruedInterestAmt",float_opt_to_json x.f_AllocGrp_AllocAccruedInterestAmt) :: (("AllocInterestAtMaturity",float_opt_to_json x.f_AllocGrp_AllocInterestAtMaturity) :: (("AllocSettlInstType",allocsettlinsttype_opt_to_json x.f_AllocGrp_AllocSettlInstType) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_AllocGrp_NestedParties) :: (("MiscFeesGrp",rg_for_json miscfeesgrp_to_json x.f_AllocGrp_MiscFeesGrp) :: (("ClrInstGrp",rg_for_json clrinstgrp_to_json x.f_AllocGrp_ClrInstGrp) :: [])))))))))))))))))))))))))))))
;;
