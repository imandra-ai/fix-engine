...
let orderqtydata_to_json (x)  : json =
    assoc_filter_nulls (("RoundingDirection",roundingdirection_opt_to_json x.f_OrderQtyData_RoundingDirection) :: (("RoundingModulus",float_opt_to_json x.f_OrderQtyData_RoundingModulus) :: (("OrderPercent",float_6_opt_to_json x.f_OrderQtyData_OrderPercent) :: (("CashOrderQty",float_6_opt_to_json x.f_OrderQtyData_CashOrderQty) :: (("OrderQty",float_6_opt_to_json x.f_OrderQtyData_OrderQty) :: [])))))
;;
...
let cpctyconfgrp_to_json (x)  : json =
    assoc_filter_nulls (("OrderCapacity",ordercapacity_opt_to_json x.f_CpctyConfGrp_OrderCapacity) :: (("NoCapacities",int_opt_to_json x.f_CpctyConfGrp_NoCapacities) :: (("OrderCapacityQty",float_6_opt_to_json x.f_CpctyConfGrp_OrderCapacityQty) :: (("OrderRestrictions",orderrestrictions_opt_to_json x.f_CpctyConfGrp_OrderRestrictions) :: []))))
;;
...
let ordercancelreplacerequestallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_OrderCancelReplaceRequestAllocs_NoAllocs) :: (("AllocShares",float_6_opt_to_json x.f_OrderCancelReplaceRequestAllocs_AllocShares) :: (("AllocAccount",string_opt_to_json x.f_OrderCancelReplaceRequestAllocs_AllocAccount) :: [])))
;;
...
let execallocgrp_to_json (x)  : json =
    assoc_filter_nulls (("LastPx",float_4_opt_to_json x.f_ExecAllocGrp_LastPx) :: (("ExecID",string_opt_to_json x.f_ExecAllocGrp_ExecID) :: (("NoExecs",int_opt_to_json x.f_ExecAllocGrp_NoExecs) :: (("LastParPx",float_4_opt_to_json x.f_ExecAllocGrp_LastParPx) :: (("LastQty",float_6_opt_to_json x.f_ExecAllocGrp_LastQty) :: (("SecondaryExecID",string_opt_to_json x.f_ExecAllocGrp_SecondaryExecID) :: (("LastCapacity",lastcapacity_opt_to_json x.f_ExecAllocGrp_LastCapacity) :: [])))))))
;;
...
let allocationallocs_to_json (x)  : json =
    assoc_filter_nulls (("SettlCurrFxRate",float_opt_to_json x.f_AllocationAllocs_SettlCurrFxRate) :: (("NoAllocs",int_opt_to_json x.f_AllocationAllocs_NoAllocs) :: (("AllocNetMoney",float_6_opt_to_json x.f_AllocationAllocs_AllocNetMoney) :: (("SettlInstMode",settlinstmode_opt_to_json x.f_AllocationAllocs_SettlInstMode) :: (("SettlCurrAmt",float_6_opt_to_json x.f_AllocationAllocs_SettlCurrAmt) :: (("AllocText",string_opt_to_json x.f_AllocationAllocs_AllocText) :: (("SettlCurrFxRateCalc",char_opt_to_json x.f_AllocationAllocs_SettlCurrFxRateCalc) :: (("AllocShares",float_6_opt_to_json x.f_AllocationAllocs_AllocShares) :: (("AllocAccount",string_opt_to_json x.f_AllocationAllocs_AllocAccount) :: (("Commission",float_6_opt_to_json x.f_AllocationAllocs_Commission) :: (("ProcessCode",processcode_opt_to_json x.f_AllocationAllocs_ProcessCode) :: (("CommType",commtype_opt_to_json x.f_AllocationAllocs_CommType) :: (("AccruedInterestAmt",float_6_opt_to_json x.f_AllocationAllocs_AccruedInterestAmt) :: (("AllocPrice",float_4_opt_to_json x.f_AllocationAllocs_AllocPrice) :: (("ExecBroker",string_opt_to_json x.f_AllocationAllocs_ExecBroker) :: (("BrokerOfCredit",string_opt_to_json x.f_AllocationAllocs_BrokerOfCredit) :: (("EncodedAllocText",string_opt_to_json x.f_AllocationAllocs_EncodedAllocText) :: (("SettlCurrency",currency_opt_to_json x.f_AllocationAllocs_SettlCurrency) :: (("NotifyBrokerOfCredit",notifybrokerofcredit_opt_to_json x.f_AllocationAllocs_NotifyBrokerOfCredit) :: (("AllocAvgPx",float_4_opt_to_json x.f_AllocationAllocs_AllocAvgPx) :: (("EncodedAllocTextLen",int_opt_to_json x.f_AllocationAllocs_EncodedAllocTextLen) :: (("ClientID",string_opt_to_json x.f_AllocationAllocs_ClientID) :: (("AllocHandlInst",allochandlinst_opt_to_json x.f_AllocationAllocs_AllocHandlInst) :: [])))))))))))))))))))))))
;;
...
let liststatusorders_to_json (x)  : json =
    assoc_filter_nulls (("CumQty",float_6_opt_to_json x.f_ListStatusOrders_CumQty) :: (("AvgPx",float_4_opt_to_json x.f_ListStatusOrders_AvgPx) :: (("OrdRejReason",ordrejreason_opt_to_json x.f_ListStatusOrders_OrdRejReason) :: (("EncodedTextLen",int_opt_to_json x.f_ListStatusOrders_EncodedTextLen) :: (("OrdStatus",ordstatus_opt_to_json x.f_ListStatusOrders_OrdStatus) :: (("NoOrders",int_opt_to_json x.f_ListStatusOrders_NoOrders) :: (("EncodedText",string_opt_to_json x.f_ListStatusOrders_EncodedText) :: (("ClOrdID",string_opt_to_json x.f_ListStatusOrders_ClOrdID) :: (("Text",string_opt_to_json x.f_ListStatusOrders_Text) :: (("CxlQty",float_6_opt_to_json x.f_ListStatusOrders_CxlQty) :: (("LeavesQty",float_6_opt_to_json x.f_ListStatusOrders_LeavesQty) :: [])))))))))))
;;
...
let orderlistallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_OrderListAllocs_NoAllocs) :: (("AllocShares",float_6_opt_to_json x.f_OrderListAllocs_AllocShares) :: (("AllocAccount",string_opt_to_json x.f_OrderListAllocs_AllocAccount) :: [])))
;;
...
let bidresponsebidcomponents_to_json (x)  : json =
    assoc_filter_nulls (("FutSettDate",localmktdate_opt_to_json x.f_BidResponseBidComponents_FutSettDate) :: (("FairValue",float_6_opt_to_json x.f_BidResponseBidComponents_FairValue) :: (("EncodedText",string_opt_to_json x.f_BidResponseBidComponents_EncodedText) :: (("Commission",float_6_opt_to_json x.f_BidResponseBidComponents_Commission) :: (("TradingSessionID",string_opt_to_json x.f_BidResponseBidComponents_TradingSessionID) :: (("Text",string_opt_to_json x.f_BidResponseBidComponents_Text) :: (("CommType",commtype_opt_to_json x.f_BidResponseBidComponents_CommType) :: (("NetGrossInd",netgrossind_opt_to_json x.f_BidResponseBidComponents_NetGrossInd) :: (("Side",side_opt_to_json x.f_BidResponseBidComponents_Side) :: (("EncodedTextLen",int_opt_to_json x.f_BidResponseBidComponents_EncodedTextLen) :: (("NoBidComponents",int_opt_to_json x.f_BidResponseBidComponents_NoBidComponents) :: (("Price",float_4_opt_to_json x.f_BidResponseBidComponents_Price) :: (("ListID",string_opt_to_json x.f_BidResponseBidComponents_ListID) :: (("Country",string_opt_to_json x.f_BidResponseBidComponents_Country) :: (("PriceType",pricetype_opt_to_json x.f_BidResponseBidComponents_PriceType) :: (("SettlmntTyp",settlmnttyp_opt_to_json x.f_BidResponseBidComponents_SettlmntTyp) :: []))))))))))))))))
;;
...
let executionreportcontrabrokers_to_json (x)  : json =
    assoc_filter_nulls (("ContraTradeQty",float_6_opt_to_json x.f_ExecutionReportContraBrokers_ContraTradeQty) :: (("NoContraBrokers",int_opt_to_json x.f_ExecutionReportContraBrokers_NoContraBrokers) :: (("ContraTrader",string_opt_to_json x.f_ExecutionReportContraBrokers_ContraTrader) :: (("ContraBroker",string_opt_to_json x.f_ExecutionReportContraBrokers_ContraBroker) :: (("ContraTradeTime",utctimestamp_opt_to_json x.f_ExecutionReportContraBrokers_ContraTradeTime) :: [])))))
;;
...
let allocationmiscfees_to_json (x)  : json =
    assoc_filter_nulls (("MiscFeeCurr",currency_opt_to_json x.f_AllocationMiscFees_MiscFeeCurr) :: (("MiscFeeType",miscfeetype_opt_to_json x.f_AllocationMiscFees_MiscFeeType) :: (("MiscFeeAmt",float_6_opt_to_json x.f_AllocationMiscFees_MiscFeeAmt) :: (("NoMiscFees",int_opt_to_json x.f_AllocationMiscFees_NoMiscFees) :: []))))
;;
...
let yielddata_to_json (x)  : json =
    assoc_filter_nulls (("YieldRedemptionDate",localmktdate_opt_to_json x.f_YieldData_YieldRedemptionDate) :: (("YieldType",yieldtype_opt_to_json x.f_YieldData_YieldType) :: (("YieldRedemptionPriceType",int_opt_to_json x.f_YieldData_YieldRedemptionPriceType) :: (("YieldCalcDate",localmktdate_opt_to_json x.f_YieldData_YieldCalcDate) :: (("YieldRedemptionPrice",float_4_opt_to_json x.f_YieldData_YieldRedemptionPrice) :: (("Yield",float_6_opt_to_json x.f_YieldData_Yield) :: []))))))
;;
...
let ordersingleallocs_to_json (x)  : json =
    assoc_filter_nulls (("NoAllocs",int_opt_to_json x.f_OrderSingleAllocs_NoAllocs) :: (("AllocShares",float_6_opt_to_json x.f_OrderSingleAllocs_AllocShares) :: (("AllocAccount",string_opt_to_json x.f_OrderSingleAllocs_AllocAccount) :: [])))
;;
...
let ordliststatgrp_to_json (x)  : json =
    assoc_filter_nulls (("CumQty",float_6_opt_to_json x.f_OrdListStatGrp_CumQty) :: (("OrdRejReason",ordrejreason_opt_to_json x.f_OrdListStatGrp_OrdRejReason) :: (("EncodedText",string_opt_to_json x.f_OrdListStatGrp_EncodedText) :: (("ClOrdID",string_opt_to_json x.f_OrdListStatGrp_ClOrdID) :: (("Text",string_opt_to_json x.f_OrdListStatGrp_Text) :: (("SecondaryClOrdID",string_opt_to_json x.f_OrdListStatGrp_SecondaryClOrdID) :: (("WorkingIndicator",workingindicator_opt_to_json x.f_OrdListStatGrp_WorkingIndicator) :: (("AvgPx",float_4_opt_to_json x.f_OrdListStatGrp_AvgPx) :: (("EncodedTextLen",int_opt_to_json x.f_OrdListStatGrp_EncodedTextLen) :: (("OrdStatus",ordstatus_opt_to_json x.f_OrdListStatGrp_OrdStatus) :: (("NoOrders",int_opt_to_json x.f_OrdListStatGrp_NoOrders) :: (("CxlQty",float_6_opt_to_json x.f_OrdListStatGrp_CxlQty) :: (("LeavesQty",float_6_opt_to_json x.f_OrdListStatGrp_LeavesQty) :: [])))))))))))))
;;
...
let bidrequestbiddescriptors_to_json (x)  : json =
    assoc_filter_nulls (("LiquidityNumSecurities",int_opt_to_json x.f_BidRequestBidDescriptors_LiquidityNumSecurities) :: (("NoBidDescriptors",int_opt_to_json x.f_BidRequestBidDescriptors_NoBidDescriptors) :: (("LiquidityPctLow",float_opt_to_json x.f_BidRequestBidDescriptors_LiquidityPctLow) :: (("FairValue",float_6_opt_to_json x.f_BidRequestBidDescriptors_FairValue) :: (("ValueOfFutures",float_6_opt_to_json x.f_BidRequestBidDescriptors_ValueOfFutures) :: (("BidDescriptorType",int_opt_to_json x.f_BidRequestBidDescriptors_BidDescriptorType) :: (("SideValueInd",int_opt_to_json x.f_BidRequestBidDescriptors_SideValueInd) :: (("OutsideIndexPct",float_opt_to_json x.f_BidRequestBidDescriptors_OutsideIndexPct) :: (("BidDescriptor",string_opt_to_json x.f_BidRequestBidDescriptors_BidDescriptor) :: (("LiquidityValue",float_6_opt_to_json x.f_BidRequestBidDescriptors_LiquidityValue) :: (("LiquidityPctHigh",float_opt_to_json x.f_BidRequestBidDescriptors_LiquidityPctHigh) :: (("EFPTrackingError",float_opt_to_json x.f_BidRequestBidDescriptors_EFPTrackingError) :: []))))))))))))
;;
...
let commissiondata_to_json (x)  : json =
    assoc_filter_nulls (("FundRenewWaiv",fundrenewwaiv_opt_to_json x.f_CommissionData_FundRenewWaiv) :: (("Commission",float_6_opt_to_json x.f_CommissionData_Commission) :: (("CommCurrency",currency_opt_to_json x.f_CommissionData_CommCurrency) :: (("CommType",commtype_opt_to_json x.f_CommissionData_CommType) :: []))))
;;
...
let allocationexecs_to_json (x)  : json =
    assoc_filter_nulls (("LastPx",float_4_opt_to_json x.f_AllocationExecs_LastPx) :: (("ExecID",string_opt_to_json x.f_AllocationExecs_ExecID) :: (("NoExecs",int_opt_to_json x.f_AllocationExecs_NoExecs) :: (("LastShares",float_6_opt_to_json x.f_AllocationExecs_LastShares) :: (("LastCapacity",lastcapacity_opt_to_json x.f_AllocationExecs_LastCapacity) :: [])))))
;;
...
let positionamountdata_to_json (x)  : json =
    assoc_filter_nulls (("NoPosAmt",int_opt_to_json x.f_PositionAmountData_NoPosAmt) :: (("PosAmt",float_6_opt_to_json x.f_PositionAmountData_PosAmt) :: (("PosAmtType",posamttype_opt_to_json x.f_PositionAmountData_PosAmtType) :: [])))
;;
...
let massquotequoteentries_to_json (x)  : json =
    assoc_filter_nulls (("SecurityDesc",string_opt_to_json x.f_MassQuoteQuoteEntries_SecurityDesc) :: (("CouponRate",float_opt_to_json x.f_MassQuoteQuoteEntries_CouponRate) :: (("StrikePrice",float_4_opt_to_json x.f_MassQuoteQuoteEntries_StrikePrice) :: (("ValidUntilTime",utctimestamp_opt_to_json x.f_MassQuoteQuoteEntries_ValidUntilTime) :: (("OrdType",ordtype_opt_to_json x.f_MassQuoteQuoteEntries_OrdType) :: (("OptAttribute",char_opt_to_json x.f_MassQuoteQuoteEntries_OptAttribute) :: (("OfferSpotRate",float_4_opt_to_json x.f_MassQuoteQuoteEntries_OfferSpotRate) :: (("BidForwardPoints",float_6_opt_to_json x.f_MassQuoteQuoteEntries_BidForwardPoints) :: (("EncodedIssuerLen",int_opt_to_json x.f_MassQuoteQuoteEntries_EncodedIssuerLen) :: (("ContractMultiplier",float_opt_to_json x.f_MassQuoteQuoteEntries_ContractMultiplier) :: (("EncodedSecurityDescLen",int_opt_to_json x.f_MassQuoteQuoteEntries_EncodedSecurityDescLen) :: (("PutOrCall",putorcall_opt_to_json x.f_MassQuoteQuoteEntries_PutOrCall) :: (("FutSettDate2",localmktdate_opt_to_json x.f_MassQuoteQuoteEntries_FutSettDate2) :: (("MaturityDay",int_opt_to_json x.f_MassQuoteQuoteEntries_MaturityDay) :: (("SecurityType",securitytype_opt_to_json x.f_MassQuoteQuoteEntries_SecurityType) :: (("BidSpotRate",float_4_opt_to_json x.f_MassQuoteQuoteEntries_BidSpotRate) :: (("SymbolSfx",string_opt_to_json x.f_MassQuoteQuoteEntries_SymbolSfx) :: (("FutSettDate",localmktdate_opt_to_json x.f_MassQuoteQuoteEntries_FutSettDate) :: (("Issuer",string_opt_to_json x.f_MassQuoteQuoteEntries_Issuer) :: (("OfferPx",float_4_opt_to_json x.f_MassQuoteQuoteEntries_OfferPx) :: (("MaturityMonthYear",monthyear_opt_to_json x.f_MassQuoteQuoteEntries_MaturityMonthYear) :: (("OfferSize",float_6_opt_to_json x.f_MassQuoteQuoteEntries_OfferSize) :: (("IDSource",idsource_opt_to_json x.f_MassQuoteQuoteEntries_IDSource) :: (("Symbol",string_opt_to_json x.f_MassQuoteQuoteEntries_Symbol) :: (("EncodedIssuer",string_opt_to_json x.f_MassQuoteQuoteEntries_EncodedIssuer) :: (("TradingSessionID",string_opt_to_json x.f_MassQuoteQuoteEntries_TradingSessionID) :: (("BidSize",float_6_opt_to_json x.f_MassQuoteQuoteEntries_BidSize) :: (("TransactTime",utctimestamp_opt_to_json x.f_MassQuoteQuoteEntries_TransactTime) :: (("OrderQty2",float_6_opt_to_json x.f_MassQuoteQuoteEntries_OrderQty2) :: (("Currency",currency_opt_to_json x.f_MassQuoteQuoteEntries_Currency) :: (("QuoteEntryID",string_opt_to_json x.f_MassQuoteQuoteEntries_QuoteEntryID) :: (("BidPx",float_4_opt_to_json x.f_MassQuoteQuoteEntries_BidPx) :: (("SecurityID",string_opt_to_json x.f_MassQuoteQuoteEntries_SecurityID) :: (("OfferForwardPoints",float_6_opt_to_json x.f_MassQuoteQuoteEntries_OfferForwardPoints) :: (("SecurityExchange",exchange_opt_to_json x.f_MassQuoteQuoteEntries_SecurityExchange) :: (("NoQuoteEntries",int_opt_to_json x.f_MassQuoteQuoteEntries_NoQuoteEntries) :: (("EncodedSecurityDesc",string_opt_to_json x.f_MassQuoteQuoteEntries_EncodedSecurityDesc) :: [])))))))))))))))))))))))))))))))))))))
;;
...
let instrumentextension_to_json (x)  : json =
    assoc_filter_nulls (("PctAtRisk",float_6_opt_to_json x.f_InstrumentExtension_PctAtRisk) :: (("DeliveryForm",deliveryform_opt_to_json x.f_InstrumentExtension_DeliveryForm) :: (("AttrbGrp",rg_for_json attrbgrp_to_json x.f_InstrumentExtension_AttrbGrp) :: [])))
;;
...
let ordallocgrp_to_json (x)  : json =
    assoc_filter_nulls (("OrderBookingQty",float_6_opt_to_json x.f_OrdAllocGrp_OrderBookingQty) :: (("ListID",string_opt_to_json x.f_OrdAllocGrp_ListID) :: (("NoOrders",int_opt_to_json x.f_OrdAllocGrp_NoOrders) :: (("SecondaryOrderID",string_opt_to_json x.f_OrdAllocGrp_SecondaryOrderID) :: (("ClOrdID",string_opt_to_json x.f_OrdAllocGrp_ClOrdID) :: (("OrderAvgPx",float_4_opt_to_json x.f_OrdAllocGrp_OrderAvgPx) :: (("OrderQty",float_6_opt_to_json x.f_OrdAllocGrp_OrderQty) :: (("SecondaryClOrdID",string_opt_to_json x.f_OrdAllocGrp_SecondaryClOrdID) :: (("OrderID",string_opt_to_json x.f_OrdAllocGrp_OrderID) :: (("NestedParties2",rg_for_json nestedparties2_to_json x.f_OrdAllocGrp_NestedParties2) :: []))))))))))
;;
...
let trdallocgrp_to_json (x)  : json =
    assoc_filter_nulls (("IndividualAllocID",string_opt_to_json x.f_TrdAllocGrp_IndividualAllocID) :: (("NoAllocs",int_opt_to_json x.f_TrdAllocGrp_NoAllocs) :: (("AllocSettlCurrency",currency_opt_to_json x.f_TrdAllocGrp_AllocSettlCurrency) :: (("AllocQty",float_6_opt_to_json x.f_TrdAllocGrp_AllocQty) :: (("AllocAcctIDSource",int_opt_to_json x.f_TrdAllocGrp_AllocAcctIDSource) :: (("AllocAccount",string_opt_to_json x.f_TrdAllocGrp_AllocAccount) :: (("NestedParties2",rg_for_json nestedparties2_to_json x.f_TrdAllocGrp_NestedParties2) :: [])))))))
;;
...
let preallocmleggrp_to_json (x)  : json =
    assoc_filter_nulls (("IndividualAllocID",string_opt_to_json x.f_PreAllocMlegGrp_IndividualAllocID) :: (("NoAllocs",int_opt_to_json x.f_PreAllocMlegGrp_NoAllocs) :: (("AllocSettlCurrency",currency_opt_to_json x.f_PreAllocMlegGrp_AllocSettlCurrency) :: (("AllocQty",float_6_opt_to_json x.f_PreAllocMlegGrp_AllocQty) :: (("AllocAcctIDSource",int_opt_to_json x.f_PreAllocMlegGrp_AllocAcctIDSource) :: (("AllocAccount",string_opt_to_json x.f_PreAllocMlegGrp_AllocAccount) :: (("NestedParties3",rg_for_json nestedparties3_to_json x.f_PreAllocMlegGrp_NestedParties3) :: [])))))))
;;
...
let positionqty_to_json (x)  : json =
    assoc_filter_nulls (("NoPositions",int_opt_to_json x.f_PositionQty_NoPositions) :: (("PosType",postype_opt_to_json x.f_PositionQty_PosType) :: (("ShortQty",float_6_opt_to_json x.f_PositionQty_ShortQty) :: (("LongQty",float_6_opt_to_json x.f_PositionQty_LongQty) :: (("PosQtyStatus",posqtystatus_opt_to_json x.f_PositionQty_PosQtyStatus) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_PositionQty_NestedParties) :: []))))))
;;
...
let quotentrygrp_to_json (x)  : json =
    assoc_filter_nulls (("Instrument",instrument_to_json x.f_QuotEntryGrp_Instrument) :: (("MidYield",float_6_opt_to_json x.f_QuotEntryGrp_MidYield) :: (("MidPx",float_4_opt_to_json x.f_QuotEntryGrp_MidPx) :: (("ValidUntilTime",utctimestamp_opt_to_json x.f_QuotEntryGrp_ValidUntilTime) :: (("OrdType",ordtype_opt_to_json x.f_QuotEntryGrp_OrdType) :: (("BidForwardPoints2",float_6_opt_to_json x.f_QuotEntryGrp_BidForwardPoints2) :: (("OfferSpotRate",float_4_opt_to_json x.f_QuotEntryGrp_OfferSpotRate) :: (("OfferYield",float_6_opt_to_json x.f_QuotEntryGrp_OfferYield) :: (("BidForwardPoints",float_6_opt_to_json x.f_QuotEntryGrp_BidForwardPoints) :: (("TradingSessionSubID",string_opt_to_json x.f_QuotEntryGrp_TradingSessionSubID) :: (("BidSpotRate",float_4_opt_to_json x.f_QuotEntryGrp_BidSpotRate) :: (("OfferPx",float_4_opt_to_json x.f_QuotEntryGrp_OfferPx) :: (("OfferSize",float_6_opt_to_json x.f_QuotEntryGrp_OfferSize) :: (("TradingSessionID",string_opt_to_json x.f_QuotEntryGrp_TradingSessionID) :: (("SettlDate2",localmktdate_opt_to_json x.f_QuotEntryGrp_SettlDate2) :: (("BidSize",float_6_opt_to_json x.f_QuotEntryGrp_BidSize) :: (("TransactTime",utctimestamp_opt_to_json x.f_QuotEntryGrp_TransactTime) :: (("OrderQty2",float_6_opt_to_json x.f_QuotEntryGrp_OrderQty2) :: (("Currency",currency_opt_to_json x.f_QuotEntryGrp_Currency) :: (("QuoteEntryID",string_opt_to_json x.f_QuotEntryGrp_QuoteEntryID) :: (("BidPx",float_4_opt_to_json x.f_QuotEntryGrp_BidPx) :: (("BidYield",float_6_opt_to_json x.f_QuotEntryGrp_BidYield) :: (("SettlDate",localmktdate_opt_to_json x.f_QuotEntryGrp_SettlDate) :: (("OfferForwardPoints",float_6_opt_to_json x.f_QuotEntryGrp_OfferForwardPoints) :: (("OfferForwardPoints2",float_6_opt_to_json x.f_QuotEntryGrp_OfferForwardPoints2) :: (("NoQuoteEntries",int_opt_to_json x.f_QuotEntryGrp_NoQuoteEntries) :: (("InstrmtLegGrp",rg_for_json instrmtleggrp_to_json x.f_QuotEntryGrp_InstrmtLegGrp) :: [])))))))))))))))))))))))))))
;;
...
let allocgrp_to_json (x)  : json =
    assoc_filter_nulls (("SettlInstructionsData",settlinstructionsdata_to_json x.f_AllocGrp_SettlInstructionsData) :: (("CommissionData",commissiondata_to_json x.f_AllocGrp_CommissionData) :: (("AllocAccruedInterestAmt",float_6_opt_to_json x.f_AllocGrp_AllocAccruedInterestAmt) :: (("NoAllocs",int_opt_to_json x.f_AllocGrp_NoAllocs) :: (("AllocSettlCurrAmt",float_6_opt_to_json x.f_AllocGrp_AllocSettlCurrAmt) :: (("SettlCurrAmt",float_6_opt_to_json x.f_AllocGrp_SettlCurrAmt) :: (("AllocText",string_opt_to_json x.f_AllocGrp_AllocText) :: (("AllocSettlInstType",allocsettlinsttype_opt_to_json x.f_AllocGrp_AllocSettlInstType) :: (("ProcessCode",processcode_opt_to_json x.f_AllocGrp_ProcessCode) :: (("EncodedAllocText",string_opt_to_json x.f_AllocGrp_EncodedAllocText) :: (("AllocAvgPx",float_4_opt_to_json x.f_AllocGrp_AllocAvgPx) :: (("EncodedAllocTextLen",int_opt_to_json x.f_AllocGrp_EncodedAllocTextLen) :: (("AllocHandlInst",allochandlinst_opt_to_json x.f_AllocGrp_AllocHandlInst) :: (("SettlCurrFxRate",float_opt_to_json x.f_AllocGrp_SettlCurrFxRate) :: (("AllocNetMoney",float_6_opt_to_json x.f_AllocGrp_AllocNetMoney) :: (("AllocQty",float_6_opt_to_json x.f_AllocGrp_AllocQty) :: (("AllocAcctIDSource",int_opt_to_json x.f_AllocGrp_AllocAcctIDSource) :: (("SettlCurrFxRateCalc",settlcurrfxratecalc_opt_to_json x.f_AllocGrp_SettlCurrFxRateCalc) :: (("AllocAccount",string_opt_to_json x.f_AllocGrp_AllocAccount) :: (("AllocPrice",float_4_opt_to_json x.f_AllocGrp_AllocPrice) :: (("IndividualAllocID",string_opt_to_json x.f_AllocGrp_IndividualAllocID) :: (("AllocSettlCurrency",currency_opt_to_json x.f_AllocGrp_AllocSettlCurrency) :: (("SettlCurrency",currency_opt_to_json x.f_AllocGrp_SettlCurrency) :: (("NotifyBrokerOfCredit",notifybrokerofcredit_opt_to_json x.f_AllocGrp_NotifyBrokerOfCredit) :: (("AllocInterestAtMaturity",float_6_opt_to_json x.f_AllocGrp_AllocInterestAtMaturity) :: (("MatchStatus",matchstatus_opt_to_json x.f_AllocGrp_MatchStatus) :: (("ClrInstGrp",rg_for_json clrinstgrp_to_json x.f_AllocGrp_ClrInstGrp) :: (("MiscFeesGrp",rg_for_json miscfeesgrp_to_json x.f_AllocGrp_MiscFeesGrp) :: (("NestedParties",rg_for_json nestedparties_to_json x.f_AllocGrp_NestedParties) :: [])))))))))))))))))))))))))))))
;;
