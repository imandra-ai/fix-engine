...
let encode_MsgType ( d ) =
    (match d with
        | FIX_MsgType_Heartbeat -> "0"
        | FIX_MsgType_TestRequest -> "1"
        | FIX_MsgType_ResendRequest -> "2"
        | FIX_MsgType_Reject -> "3"
        | FIX_MsgType_SequenceReset -> "4"
        | FIX_MsgType_Logout -> "5"
        | FIX_MsgType_IOI -> "6"
        | FIX_MsgType_Advertisement -> "7"
        | FIX_MsgType_ExecutionReport -> "8"
        | FIX_MsgType_OrderCancelReject -> "9"
        | FIX_MsgType_Logon -> "A"
        | FIX_MsgType_News -> "B"
        | FIX_MsgType_Email -> "C"
        | FIX_MsgType_NewOrderSingle -> "D"
        | FIX_MsgType_NewOrderList -> "E"
        | FIX_MsgType_OrderCancelRequest -> "F"
        | FIX_MsgType_OrderCancelReplaceRequest -> "G"
        | FIX_MsgType_OrderStatusRequest -> "H"
        | FIX_MsgType_AllocationInstruction -> "J"
        | FIX_MsgType_ListCancelRequest -> "K"
        | FIX_MsgType_ListExecute -> "L"
        | FIX_MsgType_ListStatusRequest -> "M"
        | FIX_MsgType_ListStatus -> "N"
        | FIX_MsgType_AllocationInstructionAck -> "P"
        | FIX_MsgType_DontKnowTrade -> "Q"
        | FIX_MsgType_QuoteRequest -> "R"
        | FIX_MsgType_Quote -> "S"
        | FIX_MsgType_SettlementInstructions -> "T"
        | FIX_MsgType_MarketDataRequest -> "V"
        | FIX_MsgType_MarketDataSnapshotFullRefresh -> "W"
        | FIX_MsgType_MarketDataIncrementalRefresh -> "X"
        | FIX_MsgType_MarketDataRequestReject -> "Y"
        | FIX_MsgType_QuoteCancel -> "Z"
        | FIX_MsgType_QuoteStatusRequest -> "a"
        | FIX_MsgType_MassQuoteAcknowledgement -> "b"
        | FIX_MsgType_SecurityDefinitionRequest -> "c"
        | FIX_MsgType_SecurityDefinition -> "d"
        | FIX_MsgType_SecurityStatusRequest -> "e"
        | FIX_MsgType_SecurityStatus -> "f"
        | FIX_MsgType_TradingSessionStatusRequest -> "g"
        | FIX_MsgType_TradingSessionStatus -> "h"
        | FIX_MsgType_MassQuote -> "i"
        | FIX_MsgType_BusinessMessageReject -> "j"
        | FIX_MsgType_BidRequest -> "k"
        | FIX_MsgType_BidResponse -> "l"
        | FIX_MsgType_ListStrikePrice -> "m"
        | FIX_MsgType_XMLNonFIX -> "n"
        | FIX_MsgType_RegistrationInstructions -> "o"
        | FIX_MsgType_RegistrationInstructionsResponse -> "p"
        | FIX_MsgType_OrderMassCancelRequest -> "q"
        | FIX_MsgType_OrderMassCancelReport -> "r"
        | FIX_MsgType_NewOrderCross -> "s"
        | FIX_MsgType_CrossOrderCancelReplaceRequest -> "t"
        | FIX_MsgType_CrossOrderCancelRequest -> "u"
        | FIX_MsgType_SecurityTypeRequest -> "v"
        | FIX_MsgType_SecurityTypes -> "w"
        | FIX_MsgType_SecurityListRequest -> "x"
        | FIX_MsgType_SecurityList -> "y"
        | FIX_MsgType_DerivativeSecurityListRequest -> "z"
        | FIX_MsgType_DerivativeSecurityList -> "AA"
        | FIX_MsgType_NewOrderMultileg -> "AB"
        | FIX_MsgType_MultilegOrderCancelReplace -> "AC"
        | FIX_MsgType_TradeCaptureReportRequest -> "AD"
        | FIX_MsgType_TradeCaptureReport -> "AE"
        | FIX_MsgType_OrderMassStatusRequest -> "AF"
        | FIX_MsgType_QuoteRequestReject -> "AG"
        | FIX_MsgType_RFQRequest -> "AH"
        | FIX_MsgType_QuoteStatusReport -> "AI"
        | FIX_MsgType_QuoteResponse -> "AJ"
        | FIX_MsgType_Confirmation -> "AK"
        | FIX_MsgType_PositionMaintenanceRequest -> "AL"
        | FIX_MsgType_PositionMaintenanceReport -> "AM"
        | FIX_MsgType_RequestForPositions -> "AN"
        | FIX_MsgType_RequestForPositionsAck -> "AO"
        | FIX_MsgType_PositionReport -> "AP"
        | FIX_MsgType_TradeCaptureReportRequestAck -> "AQ"
        | FIX_MsgType_TradeCaptureReportAck -> "AR"
        | FIX_MsgType_AllocationReport -> "AS"
        | FIX_MsgType_AllocationReportAck -> "AT"
        | FIX_MsgType_ConfirmationAck -> "AU"
        | FIX_MsgType_SettlementInstructionRequest -> "AV"
        | FIX_MsgType_AssignmentReport -> "AW"
        | FIX_MsgType_CollateralRequest -> "AX"
        | FIX_MsgType_CollateralAssignment -> "AY"
        | FIX_MsgType_CollateralResponse -> "AZ"
        | FIX_MsgType_CollateralReport -> "BA"
        | FIX_MsgType_CollateralInquiry -> "BB"
        | FIX_MsgType_NetworkCounterpartySystemStatusRequest -> "BC"
        | FIX_MsgType_NetworkCounterpartySystemStatusResponse -> "BD"
        | FIX_MsgType_UserRequest -> "BE"
        | FIX_MsgType_UserResponse -> "BF"
        | FIX_MsgType_CollateralInquiryAck -> "BG"
        | FIX_MsgType_ConfirmationRequest -> "BH"
    )
;;
