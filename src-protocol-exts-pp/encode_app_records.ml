...
let encode_ContraGrp (msg)  =
    (@) (("437",enc_opt encode_float_4 msg.f_ContraGrp_ContraTradeQty) :: (("337",enc_opt encode_string msg.f_ContraGrp_ContraTrader) :: (("655",enc_opt encode_string msg.f_ContraGrp_ContraLegRefID) :: (("375",enc_opt encode_string msg.f_ContraGrp_ContraBroker) :: (("438",enc_opt encode_UTCTimestamp msg.f_ContraGrp_ContraTradeTime) :: []))))) []
;;
...
let encode_OrderQtyData (msg)  =
    (@) (("468",enc_opt encode_RoundingDirection msg.f_OrderQtyData_RoundingDirection) :: (("469",enc_opt encode_float msg.f_OrderQtyData_RoundingModulus) :: (("516",enc_opt encode_float_4 msg.f_OrderQtyData_OrderPercent) :: (("152",enc_opt encode_float_4 msg.f_OrderQtyData_CashOrderQty) :: (("38",enc_opt encode_float_4 msg.f_OrderQtyData_OrderQty) :: []))))) []
;;
...
let encode_ExecAllocGrp (msg)  =
    (@) (("31",enc_opt encode_float_4 msg.f_ExecAllocGrp_LastPx) :: (("17",enc_opt encode_string msg.f_ExecAllocGrp_ExecID) :: (("669",enc_opt encode_float_4 msg.f_ExecAllocGrp_LastParPx) :: (("32",enc_opt encode_float_4 msg.f_ExecAllocGrp_LastQty) :: (("527",enc_opt encode_string msg.f_ExecAllocGrp_SecondaryExecID) :: (("29",enc_opt encode_LastCapacity msg.f_ExecAllocGrp_LastCapacity) :: [])))))) []
;;
...
let encode_BidDescReqGrp (msg)  =
    (@) (("441",enc_opt encode_int msg.f_BidDescReqGrp_LiquidityNumSecurities) :: (("402",enc_opt encode_float_4 msg.f_BidDescReqGrp_LiquidityPctLow) :: (("406",enc_opt encode_float_4 msg.f_BidDescReqGrp_FairValue) :: (("408",enc_opt encode_float_4 msg.f_BidDescReqGrp_ValueOfFutures) :: (("399",enc_opt encode_BidDescriptorType msg.f_BidDescReqGrp_BidDescriptorType) :: (("401",enc_opt encode_SideValueInd msg.f_BidDescReqGrp_SideValueInd) :: (("407",enc_opt encode_float_4 msg.f_BidDescReqGrp_OutsideIndexPct) :: (("400",enc_opt encode_string msg.f_BidDescReqGrp_BidDescriptor) :: (("404",enc_opt encode_float_4 msg.f_BidDescReqGrp_LiquidityValue) :: (("403",enc_opt encode_float_4 msg.f_BidDescReqGrp_LiquidityPctHigh) :: (("405",enc_opt encode_float_4 msg.f_BidDescReqGrp_EFPTrackingError) :: []))))))))))) []
;;

let encode_CpctyConfGrp (msg)  =
    (@) (("528",enc_opt encode_OrderCapacity msg.f_CpctyConfGrp_OrderCapacity) :: (("863",enc_opt encode_float_4 msg.f_CpctyConfGrp_OrderCapacityQty) :: (("529",enc_opt encode_OrderRestrictions msg.f_CpctyConfGrp_OrderRestrictions) :: []))) []
;;
...
let encode_MiscFeesGrp (msg)  =
    (@) (("891",enc_opt encode_MiscFeeBasis msg.f_MiscFeesGrp_MiscFeeBasis) :: (("138",enc_opt encode_Currency msg.f_MiscFeesGrp_MiscFeeCurr) :: (("139",enc_opt encode_MiscFeeType msg.f_MiscFeesGrp_MiscFeeType) :: (("137",enc_opt encode_float_4 msg.f_MiscFeesGrp_MiscFeeAmt) :: [])))) []
;;
...
let encode_OrdListStatGrp (msg)  =
    (@) (("14",enc_opt encode_float_4 msg.f_OrdListStatGrp_CumQty) :: (("103",enc_opt encode_OrdRejReason msg.f_OrdListStatGrp_OrdRejReason) :: (("355",enc_opt encode_string msg.f_OrdListStatGrp_EncodedText) :: (("11",enc_opt encode_string msg.f_OrdListStatGrp_ClOrdID) :: (("58",enc_opt encode_string msg.f_OrdListStatGrp_Text) :: (("526",enc_opt encode_string msg.f_OrdListStatGrp_SecondaryClOrdID) :: (("636",enc_opt encode_WorkingIndicator msg.f_OrdListStatGrp_WorkingIndicator) :: (("6",enc_opt encode_float_4 msg.f_OrdListStatGrp_AvgPx) :: (("354",enc_opt encode_int msg.f_OrdListStatGrp_EncodedTextLen) :: (("39",enc_opt encode_OrdStatus msg.f_OrdListStatGrp_OrdStatus) :: (("84",enc_opt encode_float_4 msg.f_OrdListStatGrp_CxlQty) :: (("151",enc_opt encode_float_4 msg.f_OrdListStatGrp_LeavesQty) :: [])))))))))))) []
;;

let encode_EvntGrp (msg)  =
    (@) (("865",enc_opt encode_EventType msg.f_EvntGrp_EventType) :: (("868",enc_opt encode_string msg.f_EvntGrp_EventText) :: (("866",enc_opt encode_LocalMktDate msg.f_EvntGrp_EventDate) :: (("867",enc_opt encode_float_4 msg.f_EvntGrp_EventPx) :: [])))) []
;;

let encode_SpreadOrBenchmarkCurveData (msg)  =
    (@) (("662",enc_opt encode_float_4 msg.f_SpreadOrBenchmarkCurveData_BenchmarkPrice) :: (("221",enc_opt encode_string msg.f_SpreadOrBenchmarkCurveData_BenchmarkCurveName) :: (("218",enc_opt encode_float_4 msg.f_SpreadOrBenchmarkCurveData_Spread) :: (("663",enc_opt encode_int msg.f_SpreadOrBenchmarkCurveData_BenchmarkPriceType) :: (("222",enc_opt encode_string msg.f_SpreadOrBenchmarkCurveData_BenchmarkCurvePoint) :: (("699",enc_opt encode_string msg.f_SpreadOrBenchmarkCurveData_BenchmarkSecurityID) :: (("761",enc_opt encode_string msg.f_SpreadOrBenchmarkCurveData_BenchmarkSecurityIDSource) :: (("220",enc_opt encode_Currency msg.f_SpreadOrBenchmarkCurveData_BenchmarkCurveCurrency) :: [])))))))) []
;;
...
let encode_PositionAmountData (msg)  =
    (@) (("708",enc_opt encode_float_4 msg.f_PositionAmountData_PosAmt) :: (("707",enc_opt encode_PosAmtType msg.f_PositionAmountData_PosAmtType) :: [])) []
;;
...
let encode_PreAllocMlegGrp (msg)  =
    (@) (("467",enc_opt encode_string msg.f_PreAllocMlegGrp_IndividualAllocID) :: (("736",enc_opt encode_Currency msg.f_PreAllocMlegGrp_AllocSettlCurrency) :: (("80",enc_opt encode_float_4 msg.f_PreAllocMlegGrp_AllocQty) :: (("661",enc_opt encode_int msg.f_PreAllocMlegGrp_AllocAcctIDSource) :: (("79",enc_opt encode_string msg.f_PreAllocMlegGrp_AllocAccount) :: []))))) ((@) (enc_repeat encode_NestedParties3 "948" msg.f_PreAllocMlegGrp_NestedParties3) [])
;;

let encode_PositionQty (msg)  =
    (@) (("703",enc_opt encode_PosType msg.f_PositionQty_PosType) :: (("705",enc_opt encode_float_4 msg.f_PositionQty_ShortQty) :: (("704",enc_opt encode_float_4 msg.f_PositionQty_LongQty) :: (("706",enc_opt encode_PosQtyStatus msg.f_PositionQty_PosQtyStatus) :: [])))) ((@) (enc_repeat encode_NestedParties "539" msg.f_PositionQty_NestedParties) [])
;;
...
let encode_UndInstrmtStrkPxGrp (msg)  =
    (@) (encode_UnderlyingInstrument msg.f_UndInstrmtStrkPxGrp_UnderlyingInstrument) ((@) (("54",enc_opt encode_Side msg.f_UndInstrmtStrkPxGrp_Side) :: (("354",enc_opt encode_int msg.f_UndInstrmtStrkPxGrp_EncodedTextLen) :: (("44",enc_opt encode_float_4 msg.f_UndInstrmtStrkPxGrp_Price) :: (("15",enc_opt encode_Currency msg.f_UndInstrmtStrkPxGrp_Currency) :: (("355",enc_opt encode_string msg.f_UndInstrmtStrkPxGrp_EncodedText) :: (("140",enc_opt encode_float_4 msg.f_UndInstrmtStrkPxGrp_PrevClosePx) :: (("11",enc_opt encode_string msg.f_UndInstrmtStrkPxGrp_ClOrdID) :: (("58",enc_opt encode_string msg.f_UndInstrmtStrkPxGrp_Text) :: (("526",enc_opt encode_string msg.f_UndInstrmtStrkPxGrp_SecondaryClOrdID) :: []))))))))) [])
;;

let encode_PosUndInstrmtGrp (msg)  =
    (@) (encode_UnderlyingInstrument msg.f_PosUndInstrmtGrp_UnderlyingInstrument) ((@) (("733",enc_opt encode_int msg.f_PosUndInstrmtGrp_UnderlyingSettlPriceType) :: (("732",enc_opt encode_float_4 msg.f_PosUndInstrmtGrp_UnderlyingSettlPrice) :: [])) [])
;;
...
let encode_LegQuotStatGrp (msg)  =
    (@) (encode_InstrumentLeg msg.f_LegQuotStatGrp_InstrumentLeg) ((@) (("687",enc_opt encode_float_4 msg.f_LegQuotStatGrp_LegQty) :: (("588",enc_opt encode_LocalMktDate msg.f_LegQuotStatGrp_LegSettlDate) :: (("690",enc_opt encode_LegSwapType msg.f_LegQuotStatGrp_LegSwapType) :: (("587",enc_opt encode_char msg.f_LegQuotStatGrp_LegSettlType) :: [])))) ((@) (enc_repeat encode_NestedParties "539" msg.f_LegQuotStatGrp_NestedParties) ((@) (enc_repeat encode_LegStipulations "683" msg.f_LegQuotStatGrp_LegStipulations) [])))
;;
...
let encode_TrdInstrmtLegGrp (msg)  =
    (@) (encode_InstrumentLeg msg.f_TrdInstrmtLegGrp_InstrumentLeg) ((@) (("687",enc_opt encode_float_4 msg.f_TrdInstrmtLegGrp_LegQty) :: (("564",enc_opt encode_char msg.f_TrdInstrmtLegGrp_LegPositionEffect) :: (("587",enc_opt encode_char msg.f_TrdInstrmtLegGrp_LegSettlType) :: (("637",enc_opt encode_float_4 msg.f_TrdInstrmtLegGrp_LegLastPx) :: (("566",enc_opt encode_float_4 msg.f_TrdInstrmtLegGrp_LegPrice) :: (("654",enc_opt encode_string msg.f_TrdInstrmtLegGrp_LegRefID) :: (("588",enc_opt encode_LocalMktDate msg.f_TrdInstrmtLegGrp_LegSettlDate) :: (("690",enc_opt encode_LegSwapType msg.f_TrdInstrmtLegGrp_LegSwapType) :: (("565",enc_opt encode_int msg.f_TrdInstrmtLegGrp_LegCoveredOrUncovered) :: []))))))))) ((@) (enc_repeat encode_NestedParties "539" msg.f_TrdInstrmtLegGrp_NestedParties) ((@) (enc_repeat encode_LegStipulations "683" msg.f_TrdInstrmtLegGrp_LegStipulations) [])))
;;

let encode_InstrmtLegExecGrp (msg)  =
    (@) (encode_InstrumentLeg msg.f_InstrmtLegExecGrp_InstrumentLeg) ((@) (("687",enc_opt encode_float_4 msg.f_InstrmtLegExecGrp_LegQty) :: (("564",enc_opt encode_char msg.f_InstrmtLegExecGrp_LegPositionEffect) :: (("587",enc_opt encode_char msg.f_InstrmtLegExecGrp_LegSettlType) :: (("637",enc_opt encode_float_4 msg.f_InstrmtLegExecGrp_LegLastPx) :: (("566",enc_opt encode_float_4 msg.f_InstrmtLegExecGrp_LegPrice) :: (("654",enc_opt encode_string msg.f_InstrmtLegExecGrp_LegRefID) :: (("588",enc_opt encode_LocalMktDate msg.f_InstrmtLegExecGrp_LegSettlDate) :: (("690",enc_opt encode_LegSwapType msg.f_InstrmtLegExecGrp_LegSwapType) :: (("565",enc_opt encode_int msg.f_InstrmtLegExecGrp_LegCoveredOrUncovered) :: []))))))))) ((@) (enc_repeat encode_NestedParties "539" msg.f_InstrmtLegExecGrp_NestedParties) ((@) (enc_repeat encode_LegStipulations "683" msg.f_InstrmtLegExecGrp_LegStipulations) [])))
;;

let encode_LegQuotGrp (msg)  =
    (@) (encode_InstrumentLeg msg.f_LegQuotGrp_InstrumentLeg) ((@) (encode_LegBenchmarkCurveData msg.f_LegQuotGrp_LegBenchmarkCurveData) ((@) (("681",enc_opt encode_float_4 msg.f_LegQuotGrp_LegBidPx) :: (("686",enc_opt encode_int msg.f_LegQuotGrp_LegPriceType) :: (("687",enc_opt encode_float_4 msg.f_LegQuotGrp_LegQty) :: (("588",enc_opt encode_LocalMktDate msg.f_LegQuotGrp_LegSettlDate) :: (("684",enc_opt encode_float_4 msg.f_LegQuotGrp_LegOfferPx) :: (("690",enc_opt encode_LegSwapType msg.f_LegQuotGrp_LegSwapType) :: (("587",enc_opt encode_char msg.f_LegQuotGrp_LegSettlType) :: []))))))) ((@) (enc_repeat encode_NestedParties "539" msg.f_LegQuotGrp_NestedParties) ((@) (enc_repeat encode_LegStipulations "683" msg.f_LegQuotGrp_LegStipulations) []))))
;;

let encode_OrdAllocGrp (msg)  =
    (@) (("800",enc_opt encode_float_4 msg.f_OrdAllocGrp_OrderBookingQty) :: (("66",enc_opt encode_string msg.f_OrdAllocGrp_ListID) :: (("198",enc_opt encode_string msg.f_OrdAllocGrp_SecondaryOrderID) :: (("11",enc_opt encode_string msg.f_OrdAllocGrp_ClOrdID) :: (("799",enc_opt encode_float_4 msg.f_OrdAllocGrp_OrderAvgPx) :: (("38",enc_opt encode_float_4 msg.f_OrdAllocGrp_OrderQty) :: (("526",enc_opt encode_string msg.f_OrdAllocGrp_SecondaryClOrdID) :: (("37",enc_opt encode_string msg.f_OrdAllocGrp_OrderID) :: [])))))))) ((@) (enc_repeat encode_NestedParties2 "756" msg.f_OrdAllocGrp_NestedParties2) [])
;;

let encode_TrdAllocGrp (msg)  =
    (@) (("467",enc_opt encode_string msg.f_TrdAllocGrp_IndividualAllocID) :: (("736",enc_opt encode_Currency msg.f_TrdAllocGrp_AllocSettlCurrency) :: (("80",enc_opt encode_float_4 msg.f_TrdAllocGrp_AllocQty) :: (("661",enc_opt encode_int msg.f_TrdAllocGrp_AllocAcctIDSource) :: (("79",enc_opt encode_string msg.f_TrdAllocGrp_AllocAccount) :: []))))) ((@) (enc_repeat encode_NestedParties2 "756" msg.f_TrdAllocGrp_NestedParties2) [])
;;

let encode_LegPreAllocGrp (msg)  =
    (@) (("674",enc_opt encode_string msg.f_LegPreAllocGrp_LegAllocAcctIDSource) :: (("672",enc_opt encode_string msg.f_LegPreAllocGrp_LegIndividualAllocID) :: (("673",enc_opt encode_float_4 msg.f_LegPreAllocGrp_LegAllocQty) :: (("675",enc_opt encode_Currency msg.f_LegPreAllocGrp_LegSettlCurrency) :: (("671",enc_opt encode_string msg.f_LegPreAllocGrp_LegAllocAccount) :: []))))) ((@) (enc_repeat encode_NestedParties2 "756" msg.f_LegPreAllocGrp_NestedParties2) [])
;;

let encode_LegOrdGrp (msg)  =
    (@) (encode_InstrumentLeg msg.f_LegOrdGrp_InstrumentLeg) ((@) (("687",enc_opt encode_float_4 msg.f_LegOrdGrp_LegQty) :: (("564",enc_opt encode_char msg.f_LegOrdGrp_LegPositionEffect) :: (("587",enc_opt encode_char msg.f_LegOrdGrp_LegSettlType) :: (("566",enc_opt encode_float_4 msg.f_LegOrdGrp_LegPrice) :: (("654",enc_opt encode_string msg.f_LegOrdGrp_LegRefID) :: (("588",enc_opt encode_LocalMktDate msg.f_LegOrdGrp_LegSettlDate) :: (("690",enc_opt encode_LegSwapType msg.f_LegOrdGrp_LegSwapType) :: (("565",enc_opt encode_int msg.f_LegOrdGrp_LegCoveredOrUncovered) :: [])))))))) ((@) (enc_repeat encode_NestedParties "539" msg.f_LegOrdGrp_NestedParties) ((@) (enc_repeat encode_LegPreAllocGrp "670" msg.f_LegOrdGrp_LegPreAllocGrp) ((@) (enc_repeat encode_LegStipulations "683" msg.f_LegOrdGrp_LegStipulations) []))))
;;

let encode_TrdCapRptSideGrp (msg)  =
    (@) (encode_CommissionData msg.f_TrdCapRptSideGrp_CommissionData) ((@) (("483",enc_opt encode_UTCTimestamp msg.f_TrdCapRptSideGrp_TransBkdTime) :: (("377",enc_opt encode_SolicitedFlag msg.f_TrdCapRptSideGrp_SolicitedFlag) :: (("528",enc_opt encode_OrderCapacity msg.f_TrdCapRptSideGrp_OrderCapacity) :: (("40",enc_opt encode_OrdType msg.f_TrdCapRptSideGrp_OrdType) :: (("198",enc_opt encode_string msg.f_TrdCapRptSideGrp_SecondaryOrderID) :: (("578",enc_opt encode_string msg.f_TrdCapRptSideGrp_TradeInputSource) :: (("526",enc_opt encode_string msg.f_TrdCapRptSideGrp_SecondaryClOrdID) :: (("581",enc_opt encode_AccountType msg.f_TrdCapRptSideGrp_AccountType) :: (("81",enc_opt encode_ProcessCode msg.f_TrdCapRptSideGrp_ProcessCode) :: (("159",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_AccruedInterestAmt) :: (("238",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_Concession) :: (("943",enc_opt encode_string msg.f_TrdCapRptSideGrp_TimeBracket) :: (("575",enc_opt encode_OddLot msg.f_TrdCapRptSideGrp_OddLot) :: (("1",enc_opt encode_string msg.f_TrdCapRptSideGrp_Account) :: (("660",enc_opt encode_AcctIDSource msg.f_TrdCapRptSideGrp_AcctIDSource) :: (("591",enc_opt encode_PreallocMethod msg.f_TrdCapRptSideGrp_PreallocMethod) :: (("37",enc_opt encode_string msg.f_TrdCapRptSideGrp_OrderID) :: (("54",enc_opt encode_Side msg.f_TrdCapRptSideGrp_Side) :: (("354",enc_opt encode_int msg.f_TrdCapRptSideGrp_EncodedTextLen) :: (("158",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_AccruedInterestRate) :: (("738",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_InterestAtMaturity) :: (("118",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_NetMoney) :: (("376",enc_opt encode_string msg.f_TrdCapRptSideGrp_ComplianceID) :: (("230",enc_opt encode_LocalMktDate msg.f_TrdCapRptSideGrp_ExDate) :: (("821",enc_opt encode_string msg.f_TrdCapRptSideGrp_OrderInputDevice) :: (("18",enc_opt encode_ExecInst msg.f_TrdCapRptSideGrp_ExecInst) :: (("826",enc_opt encode_TradeAllocIndicator msg.f_TrdCapRptSideGrp_TradeAllocIndicator) :: (("237",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_TotalTakedown) :: (("119",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_SettlCurrAmt) :: (("582",enc_opt encode_CustOrderCapacity msg.f_TrdCapRptSideGrp_CustOrderCapacity) :: (("11",enc_opt encode_string msg.f_TrdCapRptSideGrp_ClOrdID) :: (("922",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_EndCash) :: (("921",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_StartCash) :: (("58",enc_opt encode_string msg.f_TrdCapRptSideGrp_Text) :: (("752",enc_opt encode_SideMultiLegReportingType msg.f_TrdCapRptSideGrp_SideMultiLegReportingType) :: (("625",enc_opt encode_string msg.f_TrdCapRptSideGrp_TradingSessionSubID) :: (("381",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_GrossTradeAmt) :: (("66",enc_opt encode_string msg.f_TrdCapRptSideGrp_ListID) :: (("579",enc_opt encode_string msg.f_TrdCapRptSideGrp_TradeInputDevice) :: (("529",enc_opt encode_OrderRestrictions msg.f_TrdCapRptSideGrp_OrderRestrictions) :: (("155",enc_opt encode_float msg.f_TrdCapRptSideGrp_SettlCurrFxRate) :: (("157",enc_opt encode_int msg.f_TrdCapRptSideGrp_NumDaysInterest) :: (("156",enc_opt encode_SettlCurrFxRateCalc msg.f_TrdCapRptSideGrp_SettlCurrFxRateCalc) :: (("355",enc_opt encode_string msg.f_TrdCapRptSideGrp_EncodedText) :: (("70",enc_opt encode_string msg.f_TrdCapRptSideGrp_AllocID) :: (("336",enc_opt encode_string msg.f_TrdCapRptSideGrp_TradingSessionID) :: (("920",enc_opt encode_float_4 msg.f_TrdCapRptSideGrp_EndAccruedInterestAmt) :: (("120",enc_opt encode_Currency msg.f_TrdCapRptSideGrp_SettlCurrency) :: (("77",enc_opt encode_PositionEffect msg.f_TrdCapRptSideGrp_PositionEffect) :: (("15",enc_opt encode_Currency msg.f_TrdCapRptSideGrp_Currency) :: (("825",enc_opt encode_string msg.f_TrdCapRptSideGrp_ExchangeRule) :: []))))))))))))))))))))))))))))))))))))))))))))))))))) ((@) (enc_repeat encode_Parties "453" msg.f_TrdCapRptSideGrp_Parties) ((@) (enc_repeat encode_TrdAllocGrp "78" msg.f_TrdCapRptSideGrp_TrdAllocGrp) ((@) (enc_repeat encode_ClrInstGrp "576" msg.f_TrdCapRptSideGrp_ClrInstGrp) ((@) (enc_repeat encode_MiscFeesGrp "136" msg.f_TrdCapRptSideGrp_MiscFeesGrp) ((@) (enc_repeat encode_ContAmtGrp "518" msg.f_TrdCapRptSideGrp_ContAmtGrp) ((@) (enc_repeat encode_Stipulations "232" msg.f_TrdCapRptSideGrp_Stipulations) [])))))))
;;
...
let encode_QuotEntryGrp (msg)  =
    (@) (encode_Instrument msg.f_QuotEntryGrp_Instrument) ((@) (("633",enc_opt encode_float_4 msg.f_QuotEntryGrp_MidYield) :: (("631",enc_opt encode_float_4 msg.f_QuotEntryGrp_MidPx) :: (("62",enc_opt encode_UTCTimestamp msg.f_QuotEntryGrp_ValidUntilTime) :: (("40",enc_opt encode_OrdType msg.f_QuotEntryGrp_OrdType) :: (("642",enc_opt encode_float_4 msg.f_QuotEntryGrp_BidForwardPoints2) :: (("190",enc_opt encode_float_4 msg.f_QuotEntryGrp_OfferSpotRate) :: (("634",enc_opt encode_float_4 msg.f_QuotEntryGrp_OfferYield) :: (("189",enc_opt encode_float_4 msg.f_QuotEntryGrp_BidForwardPoints) :: (("625",enc_opt encode_string msg.f_QuotEntryGrp_TradingSessionSubID) :: (("188",enc_opt encode_float_4 msg.f_QuotEntryGrp_BidSpotRate) :: (("133",enc_opt encode_float_4 msg.f_QuotEntryGrp_OfferPx) :: (("135",enc_opt encode_float_4 msg.f_QuotEntryGrp_OfferSize) :: (("336",enc_opt encode_string msg.f_QuotEntryGrp_TradingSessionID) :: (("193",enc_opt encode_LocalMktDate msg.f_QuotEntryGrp_SettlDate2) :: (("134",enc_opt encode_float_4 msg.f_QuotEntryGrp_BidSize) :: (("60",enc_opt encode_UTCTimestamp msg.f_QuotEntryGrp_TransactTime) :: (("192",enc_opt encode_float_4 msg.f_QuotEntryGrp_OrderQty2) :: (("15",enc_opt encode_Currency msg.f_QuotEntryGrp_Currency) :: (("299",enc_opt encode_string msg.f_QuotEntryGrp_QuoteEntryID) :: (("132",enc_opt encode_float_4 msg.f_QuotEntryGrp_BidPx) :: (("632",enc_opt encode_float_4 msg.f_QuotEntryGrp_BidYield) :: (("64",enc_opt encode_LocalMktDate msg.f_QuotEntryGrp_SettlDate) :: (("191",enc_opt encode_float_4 msg.f_QuotEntryGrp_OfferForwardPoints) :: (("643",enc_opt encode_float_4 msg.f_QuotEntryGrp_OfferForwardPoints2) :: [])))))))))))))))))))))))) ((@) (enc_repeat encode_InstrmtLegGrp "555" msg.f_QuotEntryGrp_InstrmtLegGrp) []))
;;

let encode_QuotEntryAckGrp (msg)  =
    (@) (encode_Instrument msg.f_QuotEntryAckGrp_Instrument) ((@) (("633",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_MidYield) :: (("631",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_MidPx) :: (("62",enc_opt encode_UTCTimestamp msg.f_QuotEntryAckGrp_ValidUntilTime) :: (("40",enc_opt encode_OrdType msg.f_QuotEntryAckGrp_OrdType) :: (("642",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_BidForwardPoints2) :: (("190",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OfferSpotRate) :: (("634",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OfferYield) :: (("189",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_BidForwardPoints) :: (("625",enc_opt encode_string msg.f_QuotEntryAckGrp_TradingSessionSubID) :: (("188",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_BidSpotRate) :: (("133",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OfferPx) :: (("135",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OfferSize) :: (("336",enc_opt encode_string msg.f_QuotEntryAckGrp_TradingSessionID) :: (("193",enc_opt encode_LocalMktDate msg.f_QuotEntryAckGrp_SettlDate2) :: (("134",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_BidSize) :: (("60",enc_opt encode_UTCTimestamp msg.f_QuotEntryAckGrp_TransactTime) :: (("368",enc_opt encode_int msg.f_QuotEntryAckGrp_QuoteEntryRejectReason) :: (("192",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OrderQty2) :: (("15",enc_opt encode_Currency msg.f_QuotEntryAckGrp_Currency) :: (("299",enc_opt encode_string msg.f_QuotEntryAckGrp_QuoteEntryID) :: (("132",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_BidPx) :: (("632",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_BidYield) :: (("64",enc_opt encode_LocalMktDate msg.f_QuotEntryAckGrp_SettlDate) :: (("191",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OfferForwardPoints) :: (("643",enc_opt encode_float_4 msg.f_QuotEntryAckGrp_OfferForwardPoints2) :: []))))))))))))))))))))))))) ((@) (enc_repeat encode_InstrmtLegGrp "555" msg.f_QuotEntryAckGrp_InstrmtLegGrp) []))
;;

let encode_MDIncGrp (msg)  =
    (@) (encode_Instrument msg.f_MDIncGrp_Instrument) ((@) (("275",enc_opt encode_Exchange msg.f_MDIncGrp_MDMkt) :: (("58",enc_opt encode_string msg.f_MDIncGrp_Text) :: (("273",enc_opt encode_UTCTimeOnly msg.f_MDIncGrp_MDEntryTime) :: (("277",enc_opt encode_TradeCondition msg.f_MDIncGrp_TradeCondition) :: (("625",enc_opt encode_string msg.f_MDIncGrp_TradingSessionSubID) :: (("346",enc_opt encode_int msg.f_MDIncGrp_NumberOfOrders) :: (("289",enc_opt encode_string msg.f_MDIncGrp_MDEntrySeller) :: (("546",enc_opt encode_Scope msg.f_MDIncGrp_Scope) :: (("278",enc_opt encode_string msg.f_MDIncGrp_MDEntryID) :: (("290",enc_opt encode_int msg.f_MDIncGrp_MDEntryPositionNo) :: (("287",enc_opt encode_int msg.f_MDIncGrp_SellerDays) :: (("126",enc_opt encode_UTCTimestamp msg.f_MDIncGrp_ExpireTime) :: (("292",enc_opt encode_CorporateAction msg.f_MDIncGrp_CorporateAction) :: (("285",enc_opt encode_DeleteReason msg.f_MDIncGrp_DeleteReason) :: (("451",enc_opt encode_float_4 msg.f_MDIncGrp_NetChgPrevDay) :: (("270",enc_opt encode_float_4 msg.f_MDIncGrp_MDEntryPx) :: (("110",enc_opt encode_float_4 msg.f_MDIncGrp_MinQty) :: (("432",enc_opt encode_LocalMktDate msg.f_MDIncGrp_ExpireDate) :: (("355",enc_opt encode_string msg.f_MDIncGrp_EncodedText) :: (("279",enc_opt encode_MDUpdateAction msg.f_MDIncGrp_MDUpdateAction) :: (("272",enc_opt encode_UTCDateOnly msg.f_MDIncGrp_MDEntryDate) :: (("336",enc_opt encode_string msg.f_MDIncGrp_TradingSessionID) :: (("291",enc_opt encode_FinancialStatus msg.f_MDIncGrp_FinancialStatus) :: (("37",enc_opt encode_string msg.f_MDIncGrp_OrderID) :: (("280",enc_opt encode_string msg.f_MDIncGrp_MDEntryRefID) :: (("286",enc_opt encode_OpenCloseSettlFlag msg.f_MDIncGrp_OpenCloseSettlFlag) :: (("271",enc_opt encode_float_4 msg.f_MDIncGrp_MDEntrySize) :: (("274",enc_opt encode_TickDirection msg.f_MDIncGrp_TickDirection) :: (("354",enc_opt encode_int msg.f_MDIncGrp_EncodedTextLen) :: (("288",enc_opt encode_string msg.f_MDIncGrp_MDEntryBuyer) :: (("276",enc_opt encode_QuoteCondition msg.f_MDIncGrp_QuoteCondition) :: (("282",enc_opt encode_string msg.f_MDIncGrp_MDEntryOriginator) :: (("15",enc_opt encode_Currency msg.f_MDIncGrp_Currency) :: (("59",enc_opt encode_TimeInForce msg.f_MDIncGrp_TimeInForce) :: (("811",enc_opt encode_float msg.f_MDIncGrp_PriceDelta) :: (("283",enc_opt encode_string msg.f_MDIncGrp_LocationID) :: (("299",enc_opt encode_string msg.f_MDIncGrp_QuoteEntryID) :: (("18",enc_opt encode_ExecInst msg.f_MDIncGrp_ExecInst) :: (("284",enc_opt encode_string msg.f_MDIncGrp_DeskID) :: (("269",enc_opt encode_MDEntryType msg.f_MDIncGrp_MDEntryType) :: [])))))))))))))))))))))))))))))))))))))))) ((@) (enc_repeat encode_InstrmtLegGrp "555" msg.f_MDIncGrp_InstrmtLegGrp) ((@) (enc_repeat encode_UndInstrmtGrp "711" msg.f_MDIncGrp_UndInstrmtGrp) [])))
;;

let encode_QuotReqRjctGrp (msg)  =
    (@) (encode_YieldData msg.f_QuotReqRjctGrp_YieldData) ((@) (encode_SpreadOrBenchmarkCurveData msg.f_QuotReqRjctGrp_SpreadOrBenchmarkCurveData) ((@) (encode_OrderQtyData msg.f_QuotReqRjctGrp_OrderQtyData) ((@) (encode_FinancingDetails msg.f_QuotReqRjctGrp_FinancingDetails) ((@) (encode_Instrument msg.f_QuotReqRjctGrp_Instrument) ((@) (("40",enc_opt encode_OrdType msg.f_QuotReqRjctGrp_OrdType) :: (("303",enc_opt encode_QuoteRequestType msg.f_QuotReqRjctGrp_QuoteRequestType) :: (("581",enc_opt encode_AccountType msg.f_QuotReqRjctGrp_AccountType) :: (("625",enc_opt encode_string msg.f_QuotReqRjctGrp_TradingSessionSubID) :: (("854",enc_opt encode_QtyType msg.f_QuotReqRjctGrp_QtyType) :: (("44",enc_opt encode_float_4 msg.f_QuotReqRjctGrp_Price) :: (("63",enc_opt encode_SettlType msg.f_QuotReqRjctGrp_SettlType) :: (("537",enc_opt encode_QuoteType msg.f_QuotReqRjctGrp_QuoteType) :: (("126",enc_opt encode_UTCTimestamp msg.f_QuotReqRjctGrp_ExpireTime) :: (("423",enc_opt encode_PriceType msg.f_QuotReqRjctGrp_PriceType) :: (("1",enc_opt encode_string msg.f_QuotReqRjctGrp_Account) :: (("660",enc_opt encode_AcctIDSource msg.f_QuotReqRjctGrp_AcctIDSource) :: (("692",enc_opt encode_QuotePriceType msg.f_QuotReqRjctGrp_QuotePriceType) :: (("229",enc_opt encode_LocalMktDate msg.f_QuotReqRjctGrp_TradeOriginationDate) :: (("336",enc_opt encode_string msg.f_QuotReqRjctGrp_TradingSessionID) :: (("193",enc_opt encode_LocalMktDate msg.f_QuotReqRjctGrp_SettlDate2) :: (("60",enc_opt encode_UTCTimestamp msg.f_QuotReqRjctGrp_TransactTime) :: (("192",enc_opt encode_float_4 msg.f_QuotReqRjctGrp_OrderQty2) :: (("54",enc_opt encode_Side msg.f_QuotReqRjctGrp_Side) :: (("640",enc_opt encode_float_4 msg.f_QuotReqRjctGrp_Price2) :: (("15",enc_opt encode_Currency msg.f_QuotReqRjctGrp_Currency) :: (("140",enc_opt encode_float_4 msg.f_QuotReqRjctGrp_PrevClosePx) :: (("64",enc_opt encode_LocalMktDate msg.f_QuotReqRjctGrp_SettlDate) :: []))))))))))))))))))))))) ((@) (enc_repeat encode_Parties "453" msg.f_QuotReqRjctGrp_Parties) ((@) (enc_repeat encode_QuotQualGrp "735" msg.f_QuotReqRjctGrp_QuotQualGrp) ((@) (enc_repeat encode_UndInstrmtGrp "711" msg.f_QuotReqRjctGrp_UndInstrmtGrp) ((@) (enc_repeat encode_QuotReqLegsGrp "555" msg.f_QuotReqRjctGrp_QuotReqLegsGrp) ((@) (enc_repeat encode_Stipulations "232" msg.f_QuotReqRjctGrp_Stipulations) []))))))))))
;;
...
let encode_AllocGrp (msg)  =
    (@) (encode_CommissionData msg.f_AllocGrp_CommissionData) ((@) (encode_SettlInstructionsData msg.f_AllocGrp_SettlInstructionsData) ((@) (("742",enc_opt encode_float_4 msg.f_AllocGrp_AllocAccruedInterestAmt) :: (("737",enc_opt encode_float_4 msg.f_AllocGrp_AllocSettlCurrAmt) :: (("119",enc_opt encode_float_4 msg.f_AllocGrp_SettlCurrAmt) :: (("161",enc_opt encode_string msg.f_AllocGrp_AllocText) :: (("780",enc_opt encode_AllocSettlInstType msg.f_AllocGrp_AllocSettlInstType) :: (("81",enc_opt encode_ProcessCode msg.f_AllocGrp_ProcessCode) :: (("361",enc_opt encode_string msg.f_AllocGrp_EncodedAllocText) :: (("153",enc_opt encode_float_4 msg.f_AllocGrp_AllocAvgPx) :: (("360",enc_opt encode_int msg.f_AllocGrp_EncodedAllocTextLen) :: (("209",enc_opt encode_AllocHandlInst msg.f_AllocGrp_AllocHandlInst) :: (("155",enc_opt encode_float msg.f_AllocGrp_SettlCurrFxRate) :: (("154",enc_opt encode_float_4 msg.f_AllocGrp_AllocNetMoney) :: (("80",enc_opt encode_float_4 msg.f_AllocGrp_AllocQty) :: (("661",enc_opt encode_int msg.f_AllocGrp_AllocAcctIDSource) :: (("156",enc_opt encode_SettlCurrFxRateCalc msg.f_AllocGrp_SettlCurrFxRateCalc) :: (("79",enc_opt encode_string msg.f_AllocGrp_AllocAccount) :: (("366",enc_opt encode_float_4 msg.f_AllocGrp_AllocPrice) :: (("467",enc_opt encode_string msg.f_AllocGrp_IndividualAllocID) :: (("736",enc_opt encode_Currency msg.f_AllocGrp_AllocSettlCurrency) :: (("120",enc_opt encode_Currency msg.f_AllocGrp_SettlCurrency) :: (("208",enc_opt encode_NotifyBrokerOfCredit msg.f_AllocGrp_NotifyBrokerOfCredit) :: (("741",enc_opt encode_float_4 msg.f_AllocGrp_AllocInterestAtMaturity) :: (("573",enc_opt encode_MatchStatus msg.f_AllocGrp_MatchStatus) :: []))))))))))))))))))))))) ((@) (enc_repeat encode_NestedParties "539" msg.f_AllocGrp_NestedParties) ((@) (enc_repeat encode_MiscFeesGrp "136" msg.f_AllocGrp_MiscFeesGrp) ((@) (enc_repeat encode_ClrInstGrp "576" msg.f_AllocGrp_ClrInstGrp) [])))))
;;
