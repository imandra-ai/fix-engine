...
let encode_Advertisement msg =
    ...
    ( "53" , req encode_float_6 msg.f_Advertisement_Quantity );
    ( "854" , opt encode_QtyType msg.f_Advertisement_QtyType );
    ( "44" , opt encode_float_6 msg.f_Advertisement_Price );
...
let encode_AllocationInstruction msg =
    ...
    ( "53" , req encode_float_6 msg.f_AllocationInstruction_Quantity );
    ...
    ( "6" , req encode_float_6 msg.f_AllocationInstruction_AvgPx );
    ( "860" , opt encode_float_6 msg.f_AllocationInstruction_AvgParPx );
    ...
    ( "381" , opt encode_float_6 msg.f_AllocationInstruction_GrossTradeAmt );
    ( "238" , opt encode_float_6 msg.f_AllocationInstruction_Concession );
    ( "237" , opt encode_float_6 msg.f_AllocationInstruction_TotalTakedown );
    ( "118" , opt encode_float_6 msg.f_AllocationInstruction_NetMoney );
    ...
    ( "158" , opt encode_float_6 msg.f_AllocationInstruction_AccruedInterestRate );
    ( "159" , opt encode_float_6 msg.f_AllocationInstruction_AccruedInterestAmt );
    ( "540" , opt encode_float_6 msg.f_AllocationInstruction_TotalAccruedInterestAmt );
    ( "738" , opt encode_float_6 msg.f_AllocationInstruction_InterestAtMaturity );
    ( "920" , opt encode_float_6 msg.f_AllocationInstruction_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_AllocationInstruction_StartCash );
    ( "922" , opt encode_float_6 msg.f_AllocationInstruction_EndCash );
...
let encode_AllocationReport msg =
    ...
    ( "53" , req encode_float_6 msg.f_AllocationReport_Quantity );
    ...
    ( "6" , req encode_float_6 msg.f_AllocationReport_AvgPx );
    ( "860" , opt encode_float_6 msg.f_AllocationReport_AvgParPx );
    ...
    ( "381" , opt encode_float_6 msg.f_AllocationReport_GrossTradeAmt );
    ( "238" , opt encode_float_6 msg.f_AllocationReport_Concession );
    ( "237" , opt encode_float_6 msg.f_AllocationReport_TotalTakedown );
    ( "118" , opt encode_float_6 msg.f_AllocationReport_NetMoney );
    ...
    ( "158" , opt encode_float_6 msg.f_AllocationReport_AccruedInterestRate );
    ( "159" , opt encode_float_6 msg.f_AllocationReport_AccruedInterestAmt );
    ( "540" , opt encode_float_6 msg.f_AllocationReport_TotalAccruedInterestAmt );
    ( "738" , opt encode_float_6 msg.f_AllocationReport_InterestAtMaturity );
    ( "920" , opt encode_float_6 msg.f_AllocationReport_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_AllocationReport_StartCash );
    ( "922" , opt encode_float_6 msg.f_AllocationReport_EndCash );
...
let encode_AssignmentReport msg =
    ...
    ( "834" , opt encode_float_6 msg.f_AssignmentReport_ThresholdAmount );
    ( "730" , req encode_float_6 msg.f_AssignmentReport_SettlPrice );
    ( "731" , req encode_SettlPriceType msg.f_AssignmentReport_SettlPriceType );
    ( "732" , req encode_float_6 msg.f_AssignmentReport_UnderlyingSettlPrice );
    ...
    ( "745" , opt encode_float_6 msg.f_AssignmentReport_AssignmentUnit );
    ( "746" , req encode_float_6 msg.f_AssignmentReport_OpenInterest );
...
let encode_BidRequest msg =
    ...
    ( "396" , opt encode_float_6 msg.f_BidRequest_SideValue1 );
    ( "397" , opt encode_float_6 msg.f_BidRequest_SideValue2 );
    ( "409" , opt encode_LiquidityIndType msg.f_BidRequest_LiquidityIndType );
    ( "410" , opt encode_float_6 msg.f_BidRequest_WtAverageLiquidity );
    ( "411" , opt encode_ExchangeForPhysical msg.f_BidRequest_ExchangeForPhysical );
    ( "412" , opt encode_float_6 msg.f_BidRequest_OutMainCntryUIndex );
    ( "413" , opt encode_float_6 msg.f_BidRequest_CrossPercent );
...
let encode_CollateralAssignment msg =
    ...
    ( "53" , opt encode_float_6 msg.f_CollateralAssignment_Quantity );
    ( "854" , opt encode_QtyType msg.f_CollateralAssignment_QtyType );
    ( "15" , opt encode_Currency msg.f_CollateralAssignment_Currency );
    ( "899" , opt encode_float_6 msg.f_CollateralAssignment_MarginExcess );
    ( "900" , opt encode_float_6 msg.f_CollateralAssignment_TotalNetValue );
    ( "901" , opt encode_float_6 msg.f_CollateralAssignment_CashOutstanding );
    ( "54" , opt encode_Side msg.f_CollateralAssignment_Side );
    ( "44" , opt encode_float_6 msg.f_CollateralAssignment_Price );
    ( "423" , opt encode_PriceType msg.f_CollateralAssignment_PriceType );
    ( "159" , opt encode_float_6 msg.f_CollateralAssignment_AccruedInterestAmt );
    ( "920" , opt encode_float_6 msg.f_CollateralAssignment_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_CollateralAssignment_StartCash );
    ( "922" , opt encode_float_6 msg.f_CollateralAssignment_EndCash );
...
let encode_CollateralInquiry msg =
    ...
    ( "53" , opt encode_float_6 msg.f_CollateralInquiry_Quantity );
    ( "854" , opt encode_QtyType msg.f_CollateralInquiry_QtyType );
    ( "15" , opt encode_Currency msg.f_CollateralInquiry_Currency );
    ( "899" , opt encode_float_6 msg.f_CollateralInquiry_MarginExcess );
    ( "900" , opt encode_float_6 msg.f_CollateralInquiry_TotalNetValue );
    ( "901" , opt encode_float_6 msg.f_CollateralInquiry_CashOutstanding );
    ( "54" , opt encode_Side msg.f_CollateralInquiry_Side );
    ( "44" , opt encode_float_6 msg.f_CollateralInquiry_Price );
    ( "423" , opt encode_PriceType msg.f_CollateralInquiry_PriceType );
    ( "159" , opt encode_float_6 msg.f_CollateralInquiry_AccruedInterestAmt );
    ( "920" , opt encode_float_6 msg.f_CollateralInquiry_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_CollateralInquiry_StartCash );
    ( "922" , opt encode_float_6 msg.f_CollateralInquiry_EndCash );
...
let encode_CollateralInquiryAck msg =
    ...
    ( "53" , opt encode_float_6 msg.f_CollateralInquiryAck_Quantity );
...
let encode_CollateralReport msg =
    ...
    ( "53" , opt encode_float_6 msg.f_CollateralReport_Quantity );
    ( "854" , opt encode_QtyType msg.f_CollateralReport_QtyType );
    ( "15" , opt encode_Currency msg.f_CollateralReport_Currency );
    ( "899" , opt encode_float_6 msg.f_CollateralReport_MarginExcess );
    ( "900" , opt encode_float_6 msg.f_CollateralReport_TotalNetValue );
    ( "901" , opt encode_float_6 msg.f_CollateralReport_CashOutstanding );
    ( "54" , opt encode_Side msg.f_CollateralReport_Side );
    ( "44" , opt encode_float_6 msg.f_CollateralReport_Price );
    ( "423" , opt encode_PriceType msg.f_CollateralReport_PriceType );
    ( "159" , opt encode_float_6 msg.f_CollateralReport_AccruedInterestAmt );
    ( "920" , opt encode_float_6 msg.f_CollateralReport_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_CollateralReport_StartCash );
    ( "922" , opt encode_float_6 msg.f_CollateralReport_EndCash );
...
let encode_CollateralRequest msg =
    ...
    ( "53" , opt encode_float_6 msg.f_CollateralRequest_Quantity );
    ( "854" , opt encode_QtyType msg.f_CollateralRequest_QtyType );
    ( "15" , opt encode_Currency msg.f_CollateralRequest_Currency );
    ( "899" , opt encode_float_6 msg.f_CollateralRequest_MarginExcess );
    ( "900" , opt encode_float_6 msg.f_CollateralRequest_TotalNetValue );
    ( "901" , opt encode_float_6 msg.f_CollateralRequest_CashOutstanding );
    ( "54" , opt encode_Side msg.f_CollateralRequest_Side );
    ( "44" , opt encode_float_6 msg.f_CollateralRequest_Price );
    ( "423" , opt encode_PriceType msg.f_CollateralRequest_PriceType );
    ( "159" , opt encode_float_6 msg.f_CollateralRequest_AccruedInterestAmt );
    ( "920" , opt encode_float_6 msg.f_CollateralRequest_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_CollateralRequest_StartCash );
    ( "922" , opt encode_float_6 msg.f_CollateralRequest_EndCash );
...
let encode_CollateralResponse msg =
    ...
    ( "53" , opt encode_float_6 msg.f_CollateralResponse_Quantity );
    ( "854" , opt encode_QtyType msg.f_CollateralResponse_QtyType );
    ( "15" , opt encode_Currency msg.f_CollateralResponse_Currency );
    ( "899" , opt encode_float_6 msg.f_CollateralResponse_MarginExcess );
    ( "900" , opt encode_float_6 msg.f_CollateralResponse_TotalNetValue );
    ( "901" , opt encode_float_6 msg.f_CollateralResponse_CashOutstanding );
    ( "54" , opt encode_Side msg.f_CollateralResponse_Side );
    ( "44" , opt encode_float_6 msg.f_CollateralResponse_Price );
    ( "423" , opt encode_PriceType msg.f_CollateralResponse_PriceType );
    ( "159" , opt encode_float_6 msg.f_CollateralResponse_AccruedInterestAmt );
    ( "920" , opt encode_float_6 msg.f_CollateralResponse_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_CollateralResponse_StartCash );
    ( "922" , opt encode_float_6 msg.f_CollateralResponse_EndCash );
...
let encode_Confirmation msg =
    ...
    ( "80" , req encode_float_6 msg.f_Confirmation_AllocQty );
    ...
    ( "6" , req encode_float_6 msg.f_Confirmation_AvgPx );
    ( "74" , opt encode_int msg.f_Confirmation_AvgPxPrecision );
    ( "423" , opt encode_PriceType msg.f_Confirmation_PriceType );
    ( "860" , opt encode_float_6 msg.f_Confirmation_AvgParPx );
    ( "861" , opt encode_float_6 msg.f_Confirmation_ReportedPx );
    ...
    ( "381" , req encode_float_6 msg.f_Confirmation_GrossTradeAmt );
    ( "157" , opt encode_int msg.f_Confirmation_NumDaysInterest );
    ( "230" , opt encode_LocalMktDate msg.f_Confirmation_ExDate );
    ( "158" , opt encode_float_6 msg.f_Confirmation_AccruedInterestRate );
    ( "159" , opt encode_float_6 msg.f_Confirmation_AccruedInterestAmt );
    ( "738" , opt encode_float_6 msg.f_Confirmation_InterestAtMaturity );
    ( "920" , opt encode_float_6 msg.f_Confirmation_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_Confirmation_StartCash );
    ( "922" , opt encode_float_6 msg.f_Confirmation_EndCash );
    ( "238" , opt encode_float_6 msg.f_Confirmation_Concession );
    ( "237" , opt encode_float_6 msg.f_Confirmation_TotalTakedown );
    ( "118" , req encode_float_6 msg.f_Confirmation_NetMoney );
    ( "890" , opt encode_float_6 msg.f_Confirmation_MaturityNetMoney );
    ( "119" , opt encode_float_6 msg.f_Confirmation_SettlCurrAmt );
    ( "120" , opt encode_Currency msg.f_Confirmation_SettlCurrency );
    ( "155" , opt encode_float_6 msg.f_Confirmation_SettlCurrFxRate );
    ...
    ( "858" , opt encode_float_6 msg.f_Confirmation_SharedCommission );
    ]
...
let encode_CrossOrderCancelReplaceRequest msg =
    ...
    ( "110" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_MinQty );
    ( "111" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_MaxFloor );
    ...
    ( "140" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_PrevClosePx );
    ...
    ( "44" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_Price );
    ( "99" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_StopPx );
    ...
    ( "210" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_MaxShow );
    ...
    ( "849" , opt encode_float_6 msg.f_CrossOrderCancelReplaceRequest_ParticipationRate );
...
let encode_DontKnowTrade msg =
    ...
    ( "32" , opt encode_float_6 msg.f_DontKnowTrade_LastQty );
    ( "31" , opt encode_float_6 msg.f_DontKnowTrade_LastPx );
...
let encode_ExecutionReport msg =
    ...
    ( "44" , opt encode_float_6 msg.f_ExecutionReport_Price );
    ( "99" , opt encode_float_6 msg.f_ExecutionReport_StopPx );
    ( "839" , opt encode_float_6 msg.f_ExecutionReport_PeggedPrice );
    ( "845" , opt encode_float_6 msg.f_ExecutionReport_DiscretionPrice );
    ...
    ( "849" , opt encode_float_6 msg.f_ExecutionReport_ParticipationRate );
    ( "850" , opt encode_float_6 msg.f_ExecutionReport_TargetStrategyPerformance );
    ...
    ( "32" , opt encode_float_6 msg.f_ExecutionReport_LastQty );
    ( "652" , opt encode_float_6 msg.f_ExecutionReport_UnderlyingLastQty );
    ( "31" , opt encode_float_6 msg.f_ExecutionReport_LastPx );
    ( "651" , opt encode_float_6 msg.f_ExecutionReport_UnderlyingLastPx );
    ( "669" , opt encode_float_6 msg.f_ExecutionReport_LastParPx );
    ( "194" , opt encode_float_6 msg.f_ExecutionReport_LastSpotRate );
    ( "195" , opt encode_float_6 msg.f_ExecutionReport_LastForwardPoints );
    ...
    ( "151" , req encode_float_6 msg.f_ExecutionReport_LeavesQty );
    ( "14" , req encode_float_6 msg.f_ExecutionReport_CumQty );
    ( "6" , req encode_float_6 msg.f_ExecutionReport_AvgPx );
    ( "424" , opt encode_float_6 msg.f_ExecutionReport_DayOrderQty );
    ( "425" , opt encode_float_6 msg.f_ExecutionReport_DayCumQty );
    ( "426" , opt encode_float_6 msg.f_ExecutionReport_DayAvgPx );
    ...
    ( "381" , opt encode_float_6 msg.f_ExecutionReport_GrossTradeAmt );
    ( "157" , opt encode_int msg.f_ExecutionReport_NumDaysInterest );
    ( "230" , opt encode_LocalMktDate msg.f_ExecutionReport_ExDate );
    ( "158" , opt encode_float_6 msg.f_ExecutionReport_AccruedInterestRate );
    ( "159" , opt encode_float_6 msg.f_ExecutionReport_AccruedInterestAmt );
    ( "738" , opt encode_float_6 msg.f_ExecutionReport_InterestAtMaturity );
    ( "920" , opt encode_float_6 msg.f_ExecutionReport_EndAccruedInterestAmt );
    ( "921" , opt encode_float_6 msg.f_ExecutionReport_StartCash );
    ( "922" , opt encode_float_6 msg.f_ExecutionReport_EndCash );
    ...
    ( "260" , opt encode_float_6 msg.f_ExecutionReport_BasisFeaturePrice );
    ( "238" , opt encode_float_6 msg.f_ExecutionReport_Concession );
    ( "237" , opt encode_float_6 msg.f_ExecutionReport_TotalTakedown );
    ( "118" , opt encode_float_6 msg.f_ExecutionReport_NetMoney );
    ( "119" , opt encode_float_6 msg.f_ExecutionReport_SettlCurrAmt );
    ( "120" , opt encode_Currency msg.f_ExecutionReport_SettlCurrency );
    ( "155" , opt encode_float_6 msg.f_ExecutionReport_SettlCurrFxRate );
    ...
    ( "110" , opt encode_float_6 msg.f_ExecutionReport_MinQty );
    ( "111" , opt encode_float_6 msg.f_ExecutionReport_MaxFloor );
    ( "77" , opt encode_PositionEffect msg.f_ExecutionReport_PositionEffect );
    ( "210" , opt encode_float_6 msg.f_ExecutionReport_MaxShow );
    ...
    ( "192" , opt encode_float_6 msg.f_ExecutionReport_OrderQty2 );
    ( "641" , opt encode_float_6 msg.f_ExecutionReport_LastForwardPoints2 );
    ...
    ( "485" , opt encode_float_6 msg.f_ExecutionReport_ExecPriceAdjustment );
    ( "638" , opt encode_PriorityIndicator msg.f_ExecutionReport_PriorityIndicator );
    ( "639" , opt encode_float_6 msg.f_ExecutionReport_PriceImprovement );
...
let encode_IOI msg =
    ...
    ( "44" , opt encode_float_6 msg.f_IOI_Price );
...
let encode_MarketDataSnapshotFullRefresh msg =
    ...
    ( "451" , opt encode_float_6 msg.f_MarketDataSnapshotFullRefresh_NetChgPrevDay );
...
let encode_MassQuote msg =
    ...
    ( "293" , opt encode_float_6 msg.f_MassQuote_DefBidSize );
    ( "294" , opt encode_float_6 msg.f_MassQuote_DefOfferSize );
    ]
...
let encode_MultilegOrderCancelReplace msg =
    ...
    ( "110" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_MinQty );
    ( "111" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_MaxFloor );
    ...
    ( "140" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_PrevClosePx );
    ...
    ( "44" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_Price );
    ( "99" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_StopPx );
    ...
    ( "210" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_MaxShow );
    ...
    ( "849" , opt encode_float_6 msg.f_MultilegOrderCancelReplace_ParticipationRate );
...
let encode_NewOrderCross msg =
    ...
    ( "110" , opt encode_float_6 msg.f_NewOrderCross_MinQty );
    ( "111" , opt encode_float_6 msg.f_NewOrderCross_MaxFloor );
    ( "100" , opt encode_Exchange msg.f_NewOrderCross_ExDestination );
    ( "81" , opt encode_ProcessCode msg.f_NewOrderCross_ProcessCode );
    ( "140" , opt encode_float_6 msg.f_NewOrderCross_PrevClosePx );
    ...
    ( "44" , opt encode_float_6 msg.f_NewOrderCross_Price );
    ( "99" , opt encode_float_6 msg.f_NewOrderCross_StopPx );
    ...
    ( "210" , opt encode_float_6 msg.f_NewOrderCross_MaxShow );
    ...
    ( "849" , opt encode_float_6 msg.f_NewOrderCross_ParticipationRate );
...
let encode_NewOrderList msg =
    ...
    ( "765" , opt encode_float_6 msg.f_NewOrderList_AllowableOneSidednessPct );
    ( "766" , opt encode_float_6 msg.f_NewOrderList_AllowableOneSidednessValue );
...
let encode_NewOrderMultileg msg =
    ...
    ( "110" , opt encode_float_6 msg.f_NewOrderMultileg_MinQty );
    ( "111" , opt encode_float_6 msg.f_NewOrderMultileg_MaxFloor );
    ...
    ( "140" , opt encode_float_6 msg.f_NewOrderMultileg_PrevClosePx );
    ...
    ( "44" , opt encode_float_6 msg.f_NewOrderMultileg_Price );
    ( "99" , opt encode_float_6 msg.f_NewOrderMultileg_StopPx );
    ...
    ( "210" , opt encode_float_6 msg.f_NewOrderMultileg_MaxShow );
    ...
    ( "849" , opt encode_float_6 msg.f_NewOrderMultileg_ParticipationRate );
...
let encode_NewOrderSingle msg =
    ...
    ( "110" , opt encode_float_6 msg.f_NewOrderSingle_MinQty );
    ( "111" , opt encode_float_6 msg.f_NewOrderSingle_MaxFloor );
    ( "100" , opt encode_Exchange msg.f_NewOrderSingle_ExDestination );
    ( "81" , opt encode_ProcessCode msg.f_NewOrderSingle_ProcessCode );
    ( "140" , opt encode_float_6 msg.f_NewOrderSingle_PrevClosePx );
    ...
    ( "44" , opt encode_float_6 msg.f_NewOrderSingle_Price );
    ( "99" , opt encode_float_6 msg.f_NewOrderSingle_StopPx );
    ...
    ( "192" , opt encode_float_6 msg.f_NewOrderSingle_OrderQty2 );
    ( "640" , opt encode_float_6 msg.f_NewOrderSingle_Price2 );
    ...
    ( "210" , opt encode_float_6 msg.f_NewOrderSingle_MaxShow );
    ...
    ( "849" , opt encode_float_6 msg.f_NewOrderSingle_ParticipationRate );
...
let encode_OrderCancelReplaceRequest msg =
    ...
    ( "110" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_MinQty );
    ( "111" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_MaxFloor );
    ...
    ( "44" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_Price );
    ( "99" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_StopPx );
    ...
    ( "849" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_ParticipationRate );
    ...
    ( "192" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_OrderQty2 );
    ( "640" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_Price2 );
    ...
    ( "210" , opt encode_float_6 msg.f_OrderCancelReplaceRequest_MaxShow );
...
let encode_PositionMaintenanceReport msg =
    ...
    ( "834" , opt encode_float_6 msg.f_PositionMaintenanceReport_ThresholdAmount );
...
let encode_PositionMaintenanceRequest msg =
    ...
    ( "834" , opt encode_float_6 msg.f_PositionMaintenanceRequest_ThresholdAmount );
...
let encode_PositionReport msg =
    ...
    ( "730" , req encode_float_6 msg.f_PositionReport_SettlPrice );
    ( "731" , req encode_SettlPriceType msg.f_PositionReport_SettlPriceType );
    ( "734" , req encode_float_6 msg.f_PositionReport_PriorSettlPrice );
...
let encode_Quote msg =
    ...
    ( "192" , opt encode_float_6 msg.f_Quote_OrderQty2 );
    ...
    ( "132" , opt encode_float_6 msg.f_Quote_BidPx );
    ( "133" , opt encode_float_6 msg.f_Quote_OfferPx );
    ( "645" , opt encode_float_6 msg.f_Quote_MktBidPx );
    ( "646" , opt encode_float_6 msg.f_Quote_MktOfferPx );
    ( "647" , opt encode_float_6 msg.f_Quote_MinBidSize );
    ( "134" , opt encode_float_6 msg.f_Quote_BidSize );
    ( "648" , opt encode_float_6 msg.f_Quote_MinOfferSize );
    ( "135" , opt encode_float_6 msg.f_Quote_OfferSize );
    ( "62" , opt encode_UTCTimestamp msg.f_Quote_ValidUntilTime );
    ( "188" , opt encode_float_6 msg.f_Quote_BidSpotRate );
    ( "190" , opt encode_float_6 msg.f_Quote_OfferSpotRate );
    ( "189" , opt encode_float_6 msg.f_Quote_BidForwardPoints );
    ( "191" , opt encode_float_6 msg.f_Quote_OfferForwardPoints );
    ( "631" , opt encode_float_6 msg.f_Quote_MidPx );
    ( "632" , opt encode_float_6 msg.f_Quote_BidYield );
    ( "633" , opt encode_float_6 msg.f_Quote_MidYield );
    ( "634" , opt encode_float_6 msg.f_Quote_OfferYield );
    ( "60" , opt encode_UTCTimestamp msg.f_Quote_TransactTime );
    ( "40" , opt encode_OrdType msg.f_Quote_OrdType );
    ( "642" , opt encode_float_6 msg.f_Quote_BidForwardPoints2 );
    ( "643" , opt encode_float_6 msg.f_Quote_OfferForwardPoints2 );
    ( "656" , opt encode_float_6 msg.f_Quote_SettlCurrBidFxRate );
    ( "657" , opt encode_float_6 msg.f_Quote_SettlCurrOfferFxRate );
    ( "156" , opt encode_SettlCurrFxRateCalc msg.f_Quote_SettlCurrFxRateCalc );
    ( "13" , opt encode_CommType msg.f_Quote_CommType );
    ( "12" , opt encode_float_6 msg.f_Quote_Commission );
...
let encode_QuoteResponse msg =
    ...
    ( "192" , opt encode_float_6 msg.f_QuoteResponse_OrderQty2 );
    ...
    ( "132" , opt encode_float_6 msg.f_QuoteResponse_BidPx );
    ( "133" , opt encode_float_6 msg.f_QuoteResponse_OfferPx );
    ( "645" , opt encode_float_6 msg.f_QuoteResponse_MktBidPx );
    ( "646" , opt encode_float_6 msg.f_QuoteResponse_MktOfferPx );
    ( "647" , opt encode_float_6 msg.f_QuoteResponse_MinBidSize );
    ( "134" , opt encode_float_6 msg.f_QuoteResponse_BidSize );
    ( "648" , opt encode_float_6 msg.f_QuoteResponse_MinOfferSize );
    ( "135" , opt encode_float_6 msg.f_QuoteResponse_OfferSize );
    ( "62" , opt encode_UTCTimestamp msg.f_QuoteResponse_ValidUntilTime );
    ( "188" , opt encode_float_6 msg.f_QuoteResponse_BidSpotRate );
    ( "190" , opt encode_float_6 msg.f_QuoteResponse_OfferSpotRate );
    ( "189" , opt encode_float_6 msg.f_QuoteResponse_BidForwardPoints );
    ( "191" , opt encode_float_6 msg.f_QuoteResponse_OfferForwardPoints );
    ( "631" , opt encode_float_6 msg.f_QuoteResponse_MidPx );
    ( "632" , opt encode_float_6 msg.f_QuoteResponse_BidYield );
    ( "633" , opt encode_float_6 msg.f_QuoteResponse_MidYield );
    ( "634" , opt encode_float_6 msg.f_QuoteResponse_OfferYield );
    ( "60" , opt encode_UTCTimestamp msg.f_QuoteResponse_TransactTime );
    ( "40" , opt encode_OrdType msg.f_QuoteResponse_OrdType );
    ( "642" , opt encode_float_6 msg.f_QuoteResponse_BidForwardPoints2 );
    ( "643" , opt encode_float_6 msg.f_QuoteResponse_OfferForwardPoints2 );
    ( "656" , opt encode_float_6 msg.f_QuoteResponse_SettlCurrBidFxRate );
    ( "657" , opt encode_float_6 msg.f_QuoteResponse_SettlCurrOfferFxRate );
    ( "156" , opt encode_SettlCurrFxRateCalc msg.f_QuoteResponse_SettlCurrFxRateCalc );
    ( "12" , opt encode_float_6 msg.f_QuoteResponse_Commission );
    ...
    ( "44" , opt encode_float_6 msg.f_QuoteResponse_Price );
...
let encode_QuoteStatusReport msg =
    ...
    ( "192" , opt encode_float_6 msg.f_QuoteStatusReport_OrderQty2 );
    ...
    ( "44" , opt encode_float_6 msg.f_QuoteStatusReport_Price );
    ( "423" , opt encode_PriceType msg.f_QuoteStatusReport_PriceType );
    ( "132" , opt encode_float_6 msg.f_QuoteStatusReport_BidPx );
    ( "133" , opt encode_float_6 msg.f_QuoteStatusReport_OfferPx );
    ( "645" , opt encode_float_6 msg.f_QuoteStatusReport_MktBidPx );
    ( "646" , opt encode_float_6 msg.f_QuoteStatusReport_MktOfferPx );
    ( "647" , opt encode_float_6 msg.f_QuoteStatusReport_MinBidSize );
    ( "134" , opt encode_float_6 msg.f_QuoteStatusReport_BidSize );
    ( "648" , opt encode_float_6 msg.f_QuoteStatusReport_MinOfferSize );
    ( "135" , opt encode_float_6 msg.f_QuoteStatusReport_OfferSize );
    ( "62" , opt encode_UTCTimestamp msg.f_QuoteStatusReport_ValidUntilTime );
    ( "188" , opt encode_float_6 msg.f_QuoteStatusReport_BidSpotRate );
    ( "190" , opt encode_float_6 msg.f_QuoteStatusReport_OfferSpotRate );
    ( "189" , opt encode_float_6 msg.f_QuoteStatusReport_BidForwardPoints );
    ( "191" , opt encode_float_6 msg.f_QuoteStatusReport_OfferForwardPoints );
    ( "631" , opt encode_float_6 msg.f_QuoteStatusReport_MidPx );
    ( "632" , opt encode_float_6 msg.f_QuoteStatusReport_BidYield );
    ( "633" , opt encode_float_6 msg.f_QuoteStatusReport_MidYield );
    ( "634" , opt encode_float_6 msg.f_QuoteStatusReport_OfferYield );
    ( "60" , opt encode_UTCTimestamp msg.f_QuoteStatusReport_TransactTime );
    ( "40" , opt encode_OrdType msg.f_QuoteStatusReport_OrdType );
    ( "642" , opt encode_float_6 msg.f_QuoteStatusReport_BidForwardPoints2 );
    ( "643" , opt encode_float_6 msg.f_QuoteStatusReport_OfferForwardPoints2 );
    ( "656" , opt encode_float_6 msg.f_QuoteStatusReport_SettlCurrBidFxRate );
    ( "657" , opt encode_float_6 msg.f_QuoteStatusReport_SettlCurrOfferFxRate );
    ...
    ( "12" , opt encode_float_6 msg.f_QuoteStatusReport_Commission );
...
let encode_SecurityDefinition msg =
    ...
    ( "561" , opt encode_float_6 msg.f_SecurityDefinition_RoundLot );
    ( "562" , opt encode_float_6 msg.f_SecurityDefinition_MinTradeVol );
    ]
...
let encode_SecurityStatus msg =
    ...
    ( "330" , opt encode_float_6 msg.f_SecurityStatus_BuyVolume );
    ( "331" , opt encode_float_6 msg.f_SecurityStatus_SellVolume );
    ( "332" , opt encode_float_6 msg.f_SecurityStatus_HighPx );
    ( "333" , opt encode_float_6 msg.f_SecurityStatus_LowPx );
    ( "31" , opt encode_float_6 msg.f_SecurityStatus_LastPx );
...
let encode_TradeCaptureReport msg =
    ...
    ( "32" , req encode_float_6 msg.f_TradeCaptureReport_LastQty );
    ( "31" , req encode_float_6 msg.f_TradeCaptureReport_LastPx );
    ( "669" , opt encode_float_6 msg.f_TradeCaptureReport_LastParPx );
    ( "194" , opt encode_float_6 msg.f_TradeCaptureReport_LastSpotRate );
    ( "195" , opt encode_float_6 msg.f_TradeCaptureReport_LastForwardPoints );
    ...
    ( "6" , opt encode_float_6 msg.f_TradeCaptureReport_AvgPx );
...
let encode_TradingSessionStatus msg =
    ...
    ( "387" , opt encode_float_6 msg.f_TradingSessionStatus_TotalVolumeTraded );
