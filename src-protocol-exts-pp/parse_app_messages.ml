...
let parse_AllocationInstruction msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_AllocationInstruction_UndInstrmtGrp ->
    block msg parse_InstrmtLegGrp @@ fun msg f_AllocationInstruction_InstrmtLegGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_AllocationInstruction_SpreadOrBenchmarkCurveData ->
    block msg parse_Parties @@ fun msg f_AllocationInstruction_Parties ->
    block msg parse_Stipulations @@ fun msg f_AllocationInstruction_Stipulations ->
    block msg parse_YieldData @@ fun msg f_AllocationInstruction_YieldData ->
    block msg parse_AllocGrp @@ fun msg f_AllocationInstruction_AllocGrp ->
...
let parse_AllocationReport msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_AllocationReport_UndInstrmtGrp ->
    block msg parse_InstrmtLegGrp @@ fun msg f_AllocationReport_InstrmtLegGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_AllocationReport_SpreadOrBenchmarkCurveData ->
    block msg parse_Parties @@ fun msg f_AllocationReport_Parties ->
    block msg parse_Stipulations @@ fun msg f_AllocationReport_Stipulations ->
    block msg parse_YieldData @@ fun msg f_AllocationReport_YieldData ->
    block msg parse_AllocGrp @@ fun msg f_AllocationReport_AllocGrp ->
...
let parse_AssignmentReport msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_AssignmentReport_UndInstrmtGrp ->
    block msg parse_PositionQty @@ fun msg f_AssignmentReport_PositionQty ->
    block msg parse_PositionAmountData @@ fun msg f_AssignmentReport_PositionAmountData ->
...
let parse_CollateralAssignment msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CollateralAssignment_InstrmtLegGrp ->
    block msg parse_UndInstrmtCollGrp @@ fun msg f_CollateralAssignment_UndInstrmtCollGrp ->
    block msg parse_TrdRegTimestamps @@ fun msg f_CollateralAssignment_TrdRegTimestamps ->
    block msg parse_MiscFeesGrp @@ fun msg f_CollateralAssignment_MiscFeesGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_CollateralAssignment_SpreadOrBenchmarkCurveData ->
    block msg parse_Stipulations @@ fun msg f_CollateralAssignment_Stipulations ->
...
let parse_CollateralInquiry msg = (
    ...
    block msg parse_TrdCollGrp @@ fun msg f_CollateralInquiry_TrdCollGrp ->
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CollateralInquiry_InstrmtLegGrp ->
    block msg parse_UndInstrmtGrp @@ fun msg f_CollateralInquiry_UndInstrmtGrp ->
    block msg parse_TrdRegTimestamps @@ fun msg f_CollateralInquiry_TrdRegTimestamps ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_CollateralInquiry_SpreadOrBenchmarkCurveData ->
    block msg parse_Stipulations @@ fun msg f_CollateralInquiry_Stipulations ->
...
let parse_CollateralInquiryAck msg = (
    ...
    block msg parse_TrdCollGrp @@ fun msg f_CollateralInquiryAck_TrdCollGrp ->
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CollateralInquiryAck_InstrmtLegGrp ->
    block msg parse_UndInstrmtGrp @@ fun msg f_CollateralInquiryAck_UndInstrmtGrp ->
...
let parse_CollateralReport msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CollateralReport_InstrmtLegGrp ->
    block msg parse_UndInstrmtGrp @@ fun msg f_CollateralReport_UndInstrmtGrp ->
    block msg parse_TrdRegTimestamps @@ fun msg f_CollateralReport_TrdRegTimestamps ->
    block msg parse_MiscFeesGrp @@ fun msg f_CollateralReport_MiscFeesGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_CollateralReport_SpreadOrBenchmarkCurveData ->
    block msg parse_Stipulations @@ fun msg f_CollateralReport_Stipulations ->
...
let parse_CollateralRequest msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CollateralRequest_InstrmtLegGrp ->
    block msg parse_UndInstrmtCollGrp @@ fun msg f_CollateralRequest_UndInstrmtCollGrp ->
    block msg parse_TrdRegTimestamps @@ fun msg f_CollateralRequest_TrdRegTimestamps ->
    block msg parse_MiscFeesGrp @@ fun msg f_CollateralRequest_MiscFeesGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_CollateralRequest_SpreadOrBenchmarkCurveData ->
    block msg parse_Stipulations @@ fun msg f_CollateralRequest_Stipulations ->
...
let parse_CollateralResponse msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CollateralResponse_InstrmtLegGrp ->
    block msg parse_UndInstrmtCollGrp @@ fun msg f_CollateralResponse_UndInstrmtCollGrp ->
    block msg parse_TrdRegTimestamps @@ fun msg f_CollateralResponse_TrdRegTimestamps ->
    block msg parse_MiscFeesGrp @@ fun msg f_CollateralResponse_MiscFeesGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_CollateralResponse_SpreadOrBenchmarkCurveData ->
    block msg parse_Stipulations @@ fun msg f_CollateralResponse_Stipulations ->
...
let parse_Confirmation msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_Confirmation_UndInstrmtGrp ->
    block msg parse_InstrmtLegGrp @@ fun msg f_Confirmation_InstrmtLegGrp ->
    block msg parse_YieldData @@ fun msg f_Confirmation_YieldData ->
    block msg parse_CpctyConfGrp @@ fun msg f_Confirmation_CpctyConfGrp ->
    ...
    block msg parse_Stipulations @@ fun msg f_Confirmation_Stipulations ->
    block msg parse_MiscFeesGrp @@ fun msg f_Confirmation_MiscFeesGrp ->
...
let parse_CrossOrderCancelReplaceRequest msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CrossOrderCancelReplaceRequest_InstrmtLegGrp ->
    block msg parse_TrdgSesGrp @@ fun msg f_CrossOrderCancelReplaceRequest_TrdgSesGrp ->
    block msg parse_Stipulations @@ fun msg f_CrossOrderCancelReplaceRequest_Stipulations ->
...
let parse_CrossOrderCancelRequest msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_CrossOrderCancelRequest_InstrmtLegGrp ->
...
let parse_Email msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_Email_InstrmtLegGrp ->
    block msg parse_LinesOfTextGrp @@ fun msg f_Email_LinesOfTextGrp ->
...
let parse_ExecutionReport msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_ExecutionReport_UndInstrmtGrp ->
    block msg parse_Stipulations @@ fun msg f_ExecutionReport_Stipulations ->
    ...
    block msg parse_ContAmtGrp @@ fun msg f_ExecutionReport_ContAmtGrp ->
    block msg parse_InstrmtLegExecGrp @@ fun msg f_ExecutionReport_InstrmtLegExecGrp ->
    block msg parse_MiscFeesGrp @@ fun msg f_ExecutionReport_MiscFeesGrp ->
...
let parse_IOI msg = (
    ...
    block msg parse_Stipulations @@ fun msg f_IOI_Stipulations ->
    block msg parse_InstrmtLegIOIGrp @@ fun msg f_IOI_InstrmtLegIOIGrp ->
    block msg parse_IOIQualGrp @@ fun msg f_IOI_IOIQualGrp ->
    block msg parse_RoutingGrp @@ fun msg f_IOI_RoutingGrp ->
...
let parse_MarketDataSnapshotFullRefresh msg = (
    ...
    block msg parse_MDFullGrp @@ fun msg f_MarketDataSnapshotFullRefresh_MDFullGrp ->
...
let parse_MultilegOrderCancelReplace msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_MultilegOrderCancelReplace_UndInstrmtGrp ->
    block msg parse_LegOrdGrp @@ fun msg f_MultilegOrderCancelReplace_LegOrdGrp ->
...
let parse_NewOrderCross msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_NewOrderCross_InstrmtLegGrp ->
    block msg parse_TrdgSesGrp @@ fun msg f_NewOrderCross_TrdgSesGrp ->
    block msg parse_Stipulations @@ fun msg f_NewOrderCross_Stipulations ->
...
let parse_NewOrderMultileg msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_NewOrderMultileg_UndInstrmtGrp ->
    block msg parse_LegOrdGrp @@ fun msg f_NewOrderMultileg_LegOrdGrp ->
...
let parse_NewOrderSingle msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_NewOrderSingle_UndInstrmtGrp ->
    block msg parse_Stipulations @@ fun msg f_NewOrderSingle_Stipulations ->
...
let parse_News msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_News_UndInstrmtGrp ->
    block msg parse_LinesOfTextGrp @@ fun msg f_News_LinesOfTextGrp ->
...
let parse_OrderCancelReplaceRequest msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_OrderCancelReplaceRequest_UndInstrmtGrp ->
...
let parse_OrderCancelRequest msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_OrderCancelRequest_UndInstrmtGrp ->
...
let parse_OrderStatusRequest msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_OrderStatusRequest_UndInstrmtGrp ->
...
let parse_PositionMaintenanceReport msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_PositionMaintenanceReport_UndInstrmtGrp ->
    block msg parse_TrdgSesGrp @@ fun msg f_PositionMaintenanceReport_TrdgSesGrp ->
    block msg parse_PositionQty @@ fun msg f_PositionMaintenanceReport_PositionQty ->
    block msg parse_PositionAmountData @@ fun msg f_PositionMaintenanceReport_PositionAmountData ->
...
let parse_PositionMaintenanceRequest msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_PositionMaintenanceRequest_UndInstrmtGrp ->
    block msg parse_TrdgSesGrp @@ fun msg f_PositionMaintenanceRequest_TrdgSesGrp ->
    block msg parse_PositionQty @@ fun msg f_PositionMaintenanceRequest_PositionQty ->
...
let parse_PositionReport msg = (
    ...
    block msg parse_PosUndInstrmtGrp @@ fun msg f_PositionReport_PosUndInstrmtGrp ->
    block msg parse_PositionQty @@ fun msg f_PositionReport_PositionQty ->
    block msg parse_PositionAmountData @@ fun msg f_PositionReport_PositionAmountData ->
...
let parse_Quote msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_Quote_UndInstrmtGrp ->
    block msg parse_OrderQtyData @@ fun msg f_Quote_OrderQtyData ->
    block msg parse_Stipulations @@ fun msg f_Quote_Stipulations ->
    block msg parse_LegQuotGrp @@ fun msg f_Quote_LegQuotGrp ->
...
let parse_QuoteResponse msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_QuoteResponse_UndInstrmtGrp ->
    block msg parse_OrderQtyData @@ fun msg f_QuoteResponse_OrderQtyData ->
    block msg parse_Stipulations @@ fun msg f_QuoteResponse_Stipulations ->
    block msg parse_LegQuotGrp @@ fun msg f_QuoteResponse_LegQuotGrp ->
...
let parse_QuoteStatusReport msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_QuoteStatusReport_UndInstrmtGrp ->
    block msg parse_OrderQtyData @@ fun msg f_QuoteStatusReport_OrderQtyData ->
    block msg parse_Stipulations @@ fun msg f_QuoteStatusReport_Stipulations ->
    block msg parse_LegQuotStatGrp @@ fun msg f_QuoteStatusReport_LegQuotStatGrp ->
    block msg parse_QuotQualGrp @@ fun msg f_QuoteStatusReport_QuotQualGrp ->
...
let parse_QuoteStatusRequest msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_QuoteStatusRequest_InstrmtLegGrp ->
    block msg parse_Parties @@ fun msg f_QuoteStatusRequest_Parties ->
...
let parse_RequestForPositions msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_RequestForPositions_UndInstrmtGrp ->
    block msg parse_TrdgSesGrp @@ fun msg f_RequestForPositions_TrdgSesGrp ->
...
let parse_RequestForPositionsAck msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_RequestForPositionsAck_UndInstrmtGrp ->
...
let parse_SecurityDefinition msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_SecurityDefinition_InstrmtLegGrp ->
...
let parse_SecurityDefinitionRequest msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_SecurityDefinitionRequest_InstrmtLegGrp ->
...
let parse_SecurityListRequest msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_SecurityListRequest_UndInstrmtGrp ->
    block msg parse_InstrmtLegGrp @@ fun msg f_SecurityListRequest_InstrmtLegGrp ->
...
let parse_SecurityStatus msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_SecurityStatus_InstrmtLegGrp ->
...
let parse_SecurityStatusRequest msg = (
    ...
    block msg parse_InstrmtLegGrp @@ fun msg f_SecurityStatusRequest_InstrmtLegGrp ->
...
let parse_TradeCaptureReport msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_TradeCaptureReport_UndInstrmtGrp ->
    block msg parse_SpreadOrBenchmarkCurveData @@ fun msg f_TradeCaptureReport_SpreadOrBenchmarkCurveData ->
    block msg parse_PositionAmountData @@ fun msg f_TradeCaptureReport_PositionAmountData ->
    block msg parse_TrdInstrmtLegGrp @@ fun msg f_TradeCaptureReport_TrdInstrmtLegGrp ->
    block msg parse_TrdRegTimestamps @@ fun msg f_TradeCaptureReport_TrdRegTimestamps ->
    block msg parse_TrdCapRptSideGrp @@ fun msg f_TradeCaptureReport_TrdCapRptSideGrp ->
...
let parse_TradeCaptureReportAck msg = (
    ...
    block msg parse_TrdAllocGrp @@ fun msg f_TradeCaptureReportAck_TrdAllocGrp ->
...
let parse_TradeCaptureReportRequest msg = (
    ...
    block msg parse_UndInstrmtGrp @@ fun msg f_TradeCaptureReportRequest_UndInstrmtGrp ->
    block msg parse_InstrmtLegGrp @@ fun msg f_TradeCaptureReportRequest_InstrmtLegGrp ->
    block msg parse_TrdCapDtGrp @@ fun msg f_TradeCaptureReportRequest_TrdCapDtGrp ->
