...
let parse_Parties ( msg ) =
    opt msg "452" parse_PartyRole (fun msg f_Parties_PartyRole -> opt msg "447" parse_PartyIDSource (fun msg f_Parties_PartyIDSource -> opt msg "448" parse_string (fun msg f_Parties_PartyID -> opt msg "453" parse_int (fun msg f_Parties_NoPartyIDs -> repeating msg "802" parse_PtysSubGrp (fun msg f_Parties_PtysSubGrp -> (ParseSuccess {
